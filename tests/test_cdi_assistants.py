...
import pytest
from dartfx.ddi.ddicdi.assistants import CdiResourceAssistant, CdiClassAssistant, CdiAssistant
...
def test_automated_instance_binding_isolation():
    ...
    def assistant_only_method(self):
...
def test_classmethod_selective_exposure():
    ...
    from dartfx.ddi.ddicdi.assistants import automate_instance_methods, CdiAssistant, CdiResourceAssistant
    from dartfx.ddi.ddicdi import model_1_0_0 as model

    class OtherAssistant(CdiResourceAssistant):
        @classmethod
        def resource_helper(cls, resource: model.CDIResource):
            return "bound"
...
def test_subclass_automatic_binding():
    class SubAssistant(CdiResourceAssistant):
        @classmethod
        def subclass_helper(cls, resource: model.CDIResource):
