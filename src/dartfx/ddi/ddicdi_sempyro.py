...
class AccessInformation(RDFModel):
    """ AccessInformation.
...
class ContactInformation(RDFModel):
    """ ContactInformation.
...
class ControlledVocabularyEntry(RDFModel):
...
class CorrespondenceDefinition(RDFModel):
...
class ElectronicMessageSystem(RDFModel):
...
class EmbargoInformation(RDFModel):
    """ EmbargoInformation.
...
class FundingInformation(RDFModel):
    """ FundingInformation.
...
class InternationalIdentifier(RDFModel):
...
class InternationalRegistrationDataIdentifier(RDFModel):
...
class InternationalString(RDFModel):
    """ InternationalString.
...
class LicenseInformation(RDFModel):
    """ LicenseInformation.
...
class ModelIdentification(RDFModel):
    """ ModelIdentification.
...
class NonDdiIdentifier(RDFModel):
    """ NonDdiIdentifier.
...
class PairedControlledVocabularyEntry(RDFModel):
...
class ProvenanceInformation(RDFModel):
...
class RationaleDefinition(RDFModel):
    """ RationaleDefinition.
...
class SpatialCoordinate(RDFModel):
    """ SpatialCoordinate.
...
class SpecializationRole(RDFModel):
    """ SpecializationRole.
...
class StructureSpecification(RDFModel):
...
class AgentRelationship(RDFModel):
    """ AgentRelationship.
...
class AuthorizationSource(RDFModel):
    """ AuthorizationSource.
...
class CategoryPosition(RDFModel):
    """ CategoryPosition.
...
class CategoryRelationStructure(RDFModel):
...
class CategoryRelationship(RDFModel):
...
class CategoryStatistic(RDFModel):
    """ CategoryStatistic.
...
class ClassificationFamily(RDFModel):
...
class ClassificationIndex(RDFModel):
    """ ClassificationIndex.
...
class ClassificationIndexEntry(RDFModel):
...
class ClassificationIndexEntryPosition(RDFModel):
...
class ClassificationItem(RDFModel):
    """ ClassificationItem.
...
class ClassificationItemPosition(RDFModel):
...
class ClassificationItemRelationship(RDFModel):
...
class ClassificationItemStructure(RDFModel):
...
class ClassificationPosition(RDFModel):
...
class ClassificationSeries(RDFModel):
...
class ClassificationSeriesStructure(RDFModel):
...
class CodeListStructure(RDFModel):
    """ CodeListStructure.
...
class CodeRelationship(RDFModel):
    """ CodeRelationship.
...
class ComponentPosition(RDFModel):
    """ ComponentPosition.
...
class ConceptRelationship(RDFModel):
    """ ConceptRelationship.
...
class ConceptStructure(RDFModel):
    """ ConceptStructure.
...
class ConceptSystemCorrespondence(RDFModel):
...
class ConceptualDomain(RDFModel):
    """ ConceptualDomain.
...
class CorrespondenceTable(RDFModel):
    """ CorrespondenceTable.
...
class DataPointPosition(RDFModel):
    """ DataPointPosition.
...
class DataPointRelationship(RDFModel):
...
class DataStructureComponent(RDFModel):
...
class EnumerationDomain(RDFModel):
    """ EnumerationDomain.
...
class ForeignKeyComponent(RDFModel):
    """ ForeignKeyComponent.
...
class InformationFlowDefinition(RDFModel):
...
class InstanceVariableMap(RDFModel):
    """ InstanceVariableMap.
...
class LogicalRecordPosition(RDFModel):
...
class LogicalRecordRelationStructure(RDFModel):
...
class LogicalRecordRelationship(RDFModel):
...
class PhysicalDataSet(RDFModel):
    """ PhysicalDataSet.
...
class PhysicalDataSetStructure(RDFModel):
...
class PhysicalLayoutRelationStructure(RDFModel):
...
class PhysicalRecordSegment(RDFModel):
...
class PhysicalRecordSegmentPosition(RDFModel):
...
class PhysicalRecordSegmentRelationship(RDFModel):
...
class PhysicalRecordSegmentStructure(RDFModel):
...
class PhysicalSegmentLayout(RDFModel):
...
class PhysicalSegmentLocation(RDFModel):
...
class PrimaryKeyComponent(RDFModel):
    """ PrimaryKeyComponent.
...
class ProductionEnvironment(RDFModel):
...
class SequencePosition(RDFModel):
    """ SequencePosition.
...
class StatisticalClassificationRelationship(RDFModel):
...
class ValueAndConceptDescription(RDFModel):
...
class ValueMappingPosition(RDFModel):
...
class ValueMappingRelationship(RDFModel):
...
class VariableCollection(RDFModel):
    """ VariableCollection.
...
class VariablePosition(RDFModel):
    """ VariablePosition.
...
class VariableRelationship(RDFModel):
...
class VariableStructure(RDFModel):
    """ VariableStructure.
