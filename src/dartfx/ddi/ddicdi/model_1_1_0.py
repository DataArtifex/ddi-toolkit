...
This code was generated by the Eclipse Acceleo module UCMIS M2T on 2026-05-20 11:45:18.
...
from rdflib import OWL, XSD, DCTERMS, Namespace, URIRef
...
class CombinedDate(CDIDataType):
    ...
    isoDate: Annotated[str | None, RdfProperty(CDI.CombinedDate_isoDate, datatype=XSD.date)] = None
...
class DataFingerprint(CDIDataType):
    """DataFingerprint
    ...
    rdf_type = str(CDI.DataFingerprint)

    algorithmSpecification: Annotated[str | None, RdfProperty(CDI.DataFingerprint_algorithmSpecification)] = None
    algorithmVersion: Annotated[str | None, RdfProperty(CDI.DataFingerprint_algorithmVersion)] = None
    typeOfFingerprint: Annotated[str | None, RdfProperty(CDI.DataFingerprint_typeOfFingerprint)] = None
    value: Annotated[str | None, RdfProperty(CDI.DataFingerprint_value)] = None
...
class Identifier(CDIDataType):
    ...
    versionDate: Annotated[str | None, RdfProperty(CDI.Identifier_versionDate, datatype=XSD.date)] = None
...
class LanguageString(CDIDataType):
    ...
    translationDate: Annotated[str | None, RdfProperty(CDI.LanguageString_translationDate, datatype=XSD.date)] = None
...
class ProvenanceInformation(CDIDataType):
    ...
    recordCreationDate: Annotated[
        str | None, RdfProperty(CDI.ProvenanceInformation_recordCreationDate, datatype=XSD.date)
    ] = None
    recordLastRevisionDate: Annotated[
        str | None, RdfProperty(CDI.ProvenanceInformation_recordLastRevisionDate, datatype=XSD.date)
    ] = None
...
class AgentListing(CDIClass):
    ...
    allowsDuplicates: Annotated[bool | None, RdfProperty(CDI.AgentListing_allowsDuplicates)] = None
...
class CategorySetStructure(CDIClass):
    ...
    rdf_type = str(CDI.CategorySetStructure)

    identifier: Annotated[Identifier | None, RdfProperty(CDI.CategorySetStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.CategorySetStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.CategorySetStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.CategorySetStructure_semantics)] = None
    specification: Annotated[StructureSpecification | None, RdfProperty(CDI.CategorySetStructure_specification)] = None
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.CategorySetStructure_topology)] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.CategorySetStructure_totality)] = None

    structures: Annotated[URIRef | None, RdfProperty(CDI.CategorySetStructure_structures_CategorySet)] = None
    has_CategoryRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.CategorySetStructure_has_CategoryRelationship)
    ] = None
...
class ConceptSystem(CDIClass):
    ...
    allowsDuplicates: Annotated[bool | None, RdfProperty(CDI.ConceptSystem_allowsDuplicates)] = None
...
class ConceptSystemStructure(CDIClass):
    ...
    rdf_type = str(CDI.ConceptSystemStructure)

    identifier: Annotated[Identifier | None, RdfProperty(CDI.ConceptSystemStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ConceptSystemStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.ConceptSystemStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ConceptSystemStructure_semantics)] = None
    specification: Annotated[StructureSpecification | None, RdfProperty(CDI.ConceptSystemStructure_specification)] = (
        None
    )
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ConceptSystemStructure_topology)] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.ConceptSystemStructure_totality)] = None

    structures: Annotated[URIRef | None, RdfProperty(CDI.ConceptSystemStructure_structures_ConceptSystem)] = None
    has_ConceptRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ConceptSystemStructure_has_ConceptRelationship)
    ] = None
...
class VariableCollection(CDIClass):
    ...
    allowsDuplicates: Annotated[bool | None, RdfProperty(CDI.VariableCollection_allowsDuplicates)] = None
...
class VariableCollectionStructure(CDIClass):
    ...
    rdf_type = str(CDI.VariableCollectionStructure)

    identifier: Annotated[Identifier | None, RdfProperty(CDI.VariableCollectionStructure_identifier)] = None
    name: Annotated[list[OrganizationName] | None, RdfProperty(CDI.VariableCollectionStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.VariableCollectionStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.VariableCollectionStructure_semantics)] = (
        None
    )
    specification: Annotated[
        StructureSpecification | None, RdfProperty(CDI.VariableCollectionStructure_specification)
    ] = None
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.VariableCollectionStructure_topology)] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.VariableCollectionStructure_totality)] = None

    structures: Annotated[URIRef | None, RdfProperty(CDI.VariableCollectionStructure_structures_VariableCollection)] = (
        None
    )
    has_VariableRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.VariableCollectionStructure_has_VariableRelationship)
    ] = None
...
class DataSet(CDIClass):
    ...
    fingerprint: Annotated[DataFingerprint | None, RdfProperty(CDI.DataSet_fingerprint)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.DataSet_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.DataSet_name)] = None
    recordCount: Annotated[int | None, RdfProperty(CDI.DataSet_recordCount)] = None
    ...
    has_InstanceVariable: Annotated[list[URIRef] | None, RdfProperty(CDI.DataSet_has_InstanceVariable)] = None
...
class Statistics(CDIClass):
    ...
    rdf_type = str(CDI.Statistics)

    identifier: Annotated[Identifier | None, RdfProperty(CDI.Statistics_identifier)] = None
    statistic: Annotated[list[Statistic] | None, RdfProperty(CDI.Statistics_statistic)] = None
    typeOfStatistic: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Statistics_typeOfStatistic)] = None

    has_StatisticsCollection: Annotated[URIRef | None, RdfProperty(CDI.Statistics_has_StatisticsCollection)] = None
    hasWeight: Annotated[URIRef | None, RdfProperty(CDI.Statistics_hasWeight_InstanceVariable)] = None
...
class DataPointRelationship(CDIClass):
    ...
    Definition
    ============
    Relations used by the segment structure of a logical record to describe specific source-target data points and their relationship.
    """
...
class LogicalRecordRelationship(CDIClass):
    ...
    Definition
    ============
    Relationships between logical records within a logical record repository structure.
    """
    ...
    has_InstanceVariableMap: Annotated[
        list[URIRef] | None, RdfProperty(CDI.LogicalRecordRelationship_has_InstanceVariableMap)
    ] = None


class LogicalRecordRepository(CDIClass):
    ...
    rdf_type = str(CDI.LogicalRecordRepository)

    aboutMissing: Annotated[InternationalString | None, RdfProperty(CDI.LogicalRecordRepository_aboutMissing)] = None
    allowsDuplicates: Annotated[bool | None, RdfProperty(CDI.LogicalRecordRepository_allowsDuplicates)] = None
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.LogicalRecordRepository_catalogDetails)] = None
    characterSet: Annotated[str | None, RdfProperty(CDI.LogicalRecordRepository_characterSet)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.LogicalRecordRepository_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.LogicalRecordRepository_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.LogicalRecordRepository_purpose)] = None
    recordCount: Annotated[int | None, RdfProperty(CDI.LogicalRecordRepository_recordCount)] = None
    repositoryType: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.LogicalRecordRepository_repositoryType)
    ] = None

    isDefinedBy_Concept: Annotated[
        list[URIRef] | None, RdfProperty(CDI.LogicalRecordRepository_isDefinedBy_Concept)
    ] = None
    has_LogicalRecord: Annotated[list[URIRef] | None, RdfProperty(CDI.LogicalRecordRepository_has_LogicalRecord)] = None


class LogicalRecordRepositoryStructure(CDIClass):
    ...
    rdf_type = str(CDI.LogicalRecordRepositoryStructure)

    identifier: Annotated[Identifier | None, RdfProperty(CDI.LogicalRecordRepositoryStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.LogicalRecordRepositoryStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.LogicalRecordRepositoryStructure_purpose)] = None
    semantics: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.LogicalRecordRepositoryStructure_semantics)
    ] = None
    specification: Annotated[
        StructureSpecification | None, RdfProperty(CDI.LogicalRecordRepositoryStructure_specification)
    ] = None
    topology: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.LogicalRecordRepositoryStructure_topology)
    ] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.LogicalRecordRepositoryStructure_totality)] = None

    structures: Annotated[
        URIRef | None, RdfProperty(CDI.LogicalRecordRepositoryStructure_structures_LogicalRecordRepository)
    ] = None
    has_LogicalRecordRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.LogicalRecordRepositoryStructure_has_LogicalRecordRelationship)
    ] = None
...
class PhysicalDataSet(CDIClass):
    ...
    characterSet: Annotated[str | None, RdfProperty(CDI.PhysicalDataSet_characterSet)] = None
    encoding: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.PhysicalDataSet_encoding)] = None
    fileSize: Annotated[float | None, RdfProperty(CDI.PhysicalDataSet_fileSize)] = None
    fileSizeUofM: Annotated[str | None, RdfProperty(CDI.PhysicalDataSet_fileSizeUofM)] = None
    fingerprint: Annotated[DataFingerprint | None, RdfProperty(CDI.PhysicalDataSet_fingerprint)] = None
    ...
    physicalFileURL: Annotated[str | None, RdfProperty(CDI.PhysicalDataSet_physicalFileURL)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.PhysicalDataSet_purpose)] = None
    recordCount: Annotated[int | None, RdfProperty(CDI.PhysicalDataSet_recordCount)] = None
    standard: Annotated[list[str] | None, RdfProperty(CDI.PhysicalDataSet_standard, datatype=DCTERMS.conformsTo)] = None

    correspondsTo_DataSet: Annotated[URIRef | None, RdfProperty(CDI.PhysicalDataSet_correspondsTo_DataSet)] = None
    uses_LogicalRecord: Annotated[URIRef | None, RdfProperty(CDI.PhysicalDataSet_uses_LogicalRecord)] = None
    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalDataSet_isDefinedBy_Concept)] = None
    has_PhysicalMapping: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalDataSet_has_PhysicalMapping)] = None
    has_PhysicalMappingPosition: Annotated[
        list[URIRef] | None, RdfProperty(CDI.PhysicalDataSet_has_PhysicalMappingPosition)
    ] = None
    has_InstanceVariable: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalDataSet_has_InstanceVariable)] = None
    has_Segment: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalDataSet_has_Segment)] = None
    has_SegmentPosition: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalDataSet_has_SegmentPosition)] = None


class PhysicalMapping(CDIClass):
    """PhysicalMapping
    ...
    rdf_type = str(CDI.PhysicalMapping)

    decimalPositions: Annotated[int | None, RdfProperty(CDI.PhysicalMapping_decimalPositions)] = None
    defaultValue: Annotated[str | None, RdfProperty(CDI.PhysicalMapping_defaultValue)] = None
    format: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.PhysicalMapping_format)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PhysicalMapping_identifier)] = None
    isRequired: Annotated[bool | None, RdfProperty(CDI.PhysicalMapping_isRequired)] = None
    maximumLength: Annotated[int | None, RdfProperty(CDI.PhysicalMapping_maximumLength)] = None
    minimumLength: Annotated[int | None, RdfProperty(CDI.PhysicalMapping_minimumLength)] = None
    nullSequence: Annotated[str | None, RdfProperty(CDI.PhysicalMapping_nullSequence)] = None
    numberPattern: Annotated[str | None, RdfProperty(CDI.PhysicalMapping_numberPattern)] = None
    position: Annotated[int | None, RdfProperty(CDI.PhysicalMapping_position)] = None
    scale: Annotated[int | None, RdfProperty(CDI.PhysicalMapping_scale)] = None

    formats: Annotated[URIRef | None, RdfProperty(CDI.PhysicalMapping_formats_InstanceVariable)] = None


class PhysicalMappingPosition(CDIClass):
    """PhysicalMappingPosition

    Definition
    ============
    Denotes the position of a physical mapping in a sequence within a physical data set.
    """

    rdf_type = str(CDI.PhysicalMappingPosition)

    identifier: Annotated[Identifier | None, RdfProperty(CDI.PhysicalMappingPosition_identifier)] = None
    value: Annotated[int, RdfProperty(CDI.PhysicalMappingPosition_value)]

    indexes: Annotated[URIRef, RdfProperty(CDI.PhysicalMappingPosition_indexes_PhysicalMapping)]


class Segment(CDIClass):
    """Segment
    ...
    rdf_type = str(CDI.Segment)

    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.Segment_catalogDetails)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Segment_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.Segment_name)] = None
    physicalFileName: Annotated[str | None, RdfProperty(CDI.Segment_physicalFileName)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.Segment_purpose)] = None

    represents: Annotated[URIRef | None, RdfProperty(CDI.Segment_represents_Population)] = None
    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.Segment_isDefinedBy_Concept)] = None
    mapsTo: Annotated[URIRef | None, RdfProperty(CDI.Segment_mapsTo_LogicalRecord)] = None
    has_DataPointPosition: Annotated[list[URIRef] | None, RdfProperty(CDI.Segment_has_DataPointPosition)] = None
    has_DataPoint: Annotated[list[URIRef] | None, RdfProperty(CDI.Segment_has_DataPoint)] = None


class SegmentPosition(CDIClass):
    """SegmentPosition
    ...
    rdf_type = str(CDI.SegmentPosition)

    identifier: Annotated[Identifier | None, RdfProperty(CDI.SegmentPosition_identifier)] = None
    value: Annotated[int, RdfProperty(CDI.SegmentPosition_value)]

    indexes: Annotated[URIRef, RdfProperty(CDI.SegmentPosition_indexes_Segment)]


class SegmentStructure(CDIClass):
    """SegmentStructure
    ...
    rdf_type = str(CDI.SegmentStructure)

    identifier: Annotated[Identifier | None, RdfProperty(CDI.SegmentStructure_identifier)] = None
    name: Annotated[ObjectName | None, RdfProperty(CDI.SegmentStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.SegmentStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.SegmentStructure_semantics)] = None
    specification: Annotated[StructureSpecification | None, RdfProperty(CDI.SegmentStructure_specification)] = None
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.SegmentStructure_topology)] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.SegmentStructure_totality)] = None

    structures: Annotated[URIRef | None, RdfProperty(CDI.SegmentStructure_structures_Segment)] = None
    has_DataPointRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.SegmentStructure_has_DataPointRelationship)
    ] = None


class StatisticsCollection(CDIClass):
    ...
    rdf_type = str(CDI.StatisticsCollection)

    identifier: Annotated[Identifier | None, RdfProperty(CDI.StatisticsCollection_identifier)] = None

    hasWeight: Annotated[URIRef | None, RdfProperty(CDI.StatisticsCollection_hasWeight_InstanceVariable)] = None
...
class Activity(CDIClass):
    ...
    end: Annotated[str | None, RdfProperty(CDI.Activity_end, datatype=XSD.dateTime)] = None
    ...
    start: Annotated[str | None, RdfProperty(CDI.Activity_start, datatype=XSD.dateTime)] = None
...
class InformationFlowDefinition(CDIClass):
    ...
    Definition
    ============
    Relationships between parameters across steps is described by the information flow definition. Each relationship creates a pathway for an information object to follow.
    Examples
    ==========
...
class Parameter(CDIClass):
    ...
    Definition
    ============
    Input or output to control logic and the step/sub-step it invokes. Parameters may take the form of any information object, including data sets and structured metadata as well as configuration information for the step/sub-step.
    Examples
    ==========
...
class ClassificationSeries(CDIClass):
    ...
    allowsDuplicates: Annotated[bool | None, RdfProperty(CDI.ClassificationSeries_allowsDuplicates)] = None
...
class ClassificationStructure(CDIClass):
    ...
    rdf_type = str(CDI.ClassificationStructure)

    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.ClassificationStructure_displayLabel)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ClassificationStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.ClassificationStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ClassificationStructure_semantics)] = None
    specification: Annotated[StructureSpecification | None, RdfProperty(CDI.ClassificationStructure_specification)] = (
        None
    )
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ClassificationStructure_topology)] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.ClassificationStructure_totality)] = None

    structures: Annotated[
        URIRef | None, RdfProperty(CDI.ClassificationStructure_structures_StatisticalClassification)
    ] = None
    has_ClassificationItemRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ClassificationStructure_has_ClassificationItemRelationship)
    ] = None
...
class CategoryStatistics(Statistics):
    ...
    rdf_type = str(CDI.CategoryStatistics)

    for_Category: Annotated[URIRef | None, RdfProperty(CDI.CategoryStatistics_for_Category)] = None
...
class TabularTextDataSet(PhysicalDataSet):
    """TabularTextDataSet
    ...
    Tabular text data sets are distinct from binary data sets which do not use a text-based encoding, and from more structured text-based data expressed in formats such as XML, JSON, or any of the RDF representations.
    """

    rdf_type = str(CDI.TabularTextDataSet)

    arrayBase: Annotated[int | None, RdfProperty(CDI.TabularTextDataSet_arrayBase)] = None
    commentPrefix: Annotated[str | None, RdfProperty(CDI.TabularTextDataSet_commentPrefix)] = None
    delimiter: Annotated[str | None, RdfProperty(CDI.TabularTextDataSet_delimiter)] = None
    escapeCharacter: Annotated[str | None, RdfProperty(CDI.TabularTextDataSet_escapeCharacter)] = None
    hasHeader: Annotated[bool | None, RdfProperty(CDI.TabularTextDataSet_hasHeader)] = None
    headerIsCaseSensitive: Annotated[bool | None, RdfProperty(CDI.TabularTextDataSet_headerIsCaseSensitive)] = None
    headerRowCount: Annotated[int | None, RdfProperty(CDI.TabularTextDataSet_headerRowCount)] = None
    isDelimited: Annotated[bool, RdfProperty(CDI.TabularTextDataSet_isDelimited)]
    isFixedWidth: Annotated[bool, RdfProperty(CDI.TabularTextDataSet_isFixedWidth)]
    lineTerminator: Annotated[list[str] | None, RdfProperty(CDI.TabularTextDataSet_lineTerminator)] = None
    nullSequence: Annotated[str | None, RdfProperty(CDI.TabularTextDataSet_nullSequence)] = None
    quoteCharacter: Annotated[str | None, RdfProperty(CDI.TabularTextDataSet_quoteCharacter)] = None
    skipBlankRows: Annotated[bool | None, RdfProperty(CDI.TabularTextDataSet_skipBlankRows)] = None
    skipDataColumns: Annotated[int | None, RdfProperty(CDI.TabularTextDataSet_skipDataColumns)] = None
    skipInitialSpace: Annotated[bool | None, RdfProperty(CDI.TabularTextDataSet_skipInitialSpace)] = None
    skipRows: Annotated[int | None, RdfProperty(CDI.TabularTextDataSet_skipRows)] = None
    tableDirection: Annotated[TableDirectionValues | None, RdfProperty(CDI.TabularTextDataSet_tableDirection)] = None
    textDirection: Annotated[TextDirectionValues | None, RdfProperty(CDI.TabularTextDataSet_textDirection)] = None
    treatConsecutiveDelimitersAsOne: Annotated[
        bool | None, RdfProperty(CDI.TabularTextDataSet_treatConsecutiveDelimitersAsOne)
    ] = None
    trim: Annotated[TrimValues | None, RdfProperty(CDI.TabularTextDataSet_trim)] = None

    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.TabularTextDataSet_isDefinedBy_Concept)] = None


class StructuredDataSet(PhysicalDataSet):
    """StructuredDataSet
    ...
    rdf_type = str(CDI.StructuredDataSet)


class TextMapping(PhysicalMapping):
    """TextMapping
    ...
    rdf_type = str(CDI.TextMapping)

    defaultDecimalSeparator: Annotated[str | None, RdfProperty(CDI.TextMapping_defaultDecimalSeparator)] = None
    defaultDigitGroupSeparator: Annotated[str | None, RdfProperty(CDI.TextMapping_defaultDigitGroupSeparator)] = None
    length: Annotated[int | None, RdfProperty(CDI.TextMapping_length)] = None
    mappingLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.TextMapping_mappingLabel)] = None


class LocatorMapping(PhysicalMapping):
    """LocatorMapping
    ...
    rdf_type = str(CDI.LocatorMapping)

    locator: Annotated[str, RdfProperty(CDI.LocatorMapping_locator)]
...
class Step(Activity):
    ...
    Definition
    ============
    Reusable, parameterized activity associated to information flows. One or more steps perform an activity.
    Examples
    ==========
...
class CodeList(EnumerationDomain):
    ...
    allowsDuplicates: Annotated[bool | None, RdfProperty(CDI.CodeList_allowsDuplicates)] = None
...
class StatisticalClassification(EnumerationDomain):
    ...
    allowsDuplicates: Annotated[bool | None, RdfProperty(CDI.StatisticalClassification_allowsDuplicates)] = None
    availableLanguage: Annotated[
...
class InstanceVariable(RepresentedVariable):
    ...
    function: Annotated[list[ControlledVocabularyEntry] | None, RdfProperty(CDI.InstanceVariable_function)] = None
    ...
    role: Annotated[list[ControlledVocabularyEntry] | None, RdfProperty(CDI.InstanceVariable_role)] = None
    source: Annotated[Reference | None, RdfProperty(CDI.InstanceVariable_source)] = None

    isDescribedBy: Annotated[URIRef | None, RdfProperty(CDI.InstanceVariable_isDescribedBy_StatisticsCollection)] = None
