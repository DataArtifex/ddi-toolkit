...
class SemPyRODeserializer:
    ...
    def _build_class_registry(self) -> None:
        ...
        """
        for _name, obj in inspect.getmembers(self.module):
    ...
    def get_class_for_type(self, rdf_type: str | URIRef) -> type[BaseModel] | None:
    ...
    def deserialize(self, graph: Graph, root_types: list[str] | None = None) -> list[BaseModel]:
    ...
    def deserialize_subject(self, graph: Graph, subject: str | URIRef | BNode) -> BaseModel | None:
        ...
        if not python_class:
            raise SemPyRODeserializationError(f"No Python class found for RDF types: {[str(t) for t in rdf_types]}")
        ...
        try:
            ...
            raise SemPyRODeserializationError(f"Failed to instantiate {python_class.__name__}: {e}") from e
    ...
    def _get_rdf_term(self, field_info: FieldInfo) -> str | None:
    ...
    def _get_inner_type(self, field_info: FieldInfo) -> type | None:
...
def from_graph(
    graph: Graph, model_module: Any, subject: str | URIRef | BNode | None = None, root_types: list[str] | None = None
...
class SemPyRODeserializableMixin:
    ...
    @classmethod
    def from_graph(cls, graph: Graph, subject: str | URIRef | BNode) -> BaseModel | None:
