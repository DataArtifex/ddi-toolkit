...
This code was generated by the Eclipse Acceleo module UCMIS M2T on 2026-02-18 19:49:18. 
...
# DATA TYPES
#
class AccessInformation (CDIDataType):
  """ AccessInformation
...
class AccessLocation (CDIDataType):
  """ AccessLocation
  ...
  uri: Annotated[Optional[list[AnyUrl]], RdfProperty(CDI.AccessLocation_uri,datatype=XSD.anyURI)] = None
  
class Address (CDIDataType):
  """ Address
...
class CatalogDetails (CDIDataType):
  """ CatalogDetails
  ...
  languageOfObject: Annotated[Optional[list[str]], RdfProperty(CDI.CatalogDetails_languageOfObject,datatype=XSD.language)] = None
...
class CombinedDate (CDIDataType):
  """ CombinedDate
...
class CommandFile (CDIDataType):
  ...
  uri: Annotated[Optional[AnyUrl], RdfProperty(CDI.CommandFile_uri,datatype=XSD.anyURI)] = None
  
class ContactInformation (CDIDataType):
  """ ContactInformation
...
class ControlledVocabularyEntry (CDIDataType):
...
class CorrespondenceDefinition (CDIDataType):
...
class ElectronicMessageSystem (CDIDataType):
...
class EmbargoInformation (CDIDataType):
  """ EmbargoInformation
...
class FundingInformation (CDIDataType):
  """ FundingInformation
...
class IndividualName (CDIDataType):
  """ IndividualName
...
class InternationalIdentifier (CDIDataType):
...
class InternationalRegistrationDataIdentifier (CDIDataType):
...
class InternationalString (CDIDataType):
  """ InternationalString
...
class LanguageString (CDIDataType):
  """ LanguageString
  ...
  language: Annotated[Optional[str], RdfProperty(CDI.LanguageString_language,datatype=XSD.language)] = None
  ...
  translationSourceLanguage: Annotated[Optional[list[str]], RdfProperty(CDI.LanguageString_translationSourceLanguage,datatype=XSD.language)] = None
  
class LicenseInformation (CDIDataType):
  """ LicenseInformation
...
class NonDdiIdentifier (CDIDataType):
  """ NonDdiIdentifier
...
class PairedControlledVocabularyEntry (CDIDataType):
...
class PrivateImage (CDIDataType):
  """ PrivateImage
...
class ProvenanceInformation (CDIDataType):
...
class RationaleDefinition (CDIDataType):
  """ RationaleDefinition
...
class Reference (CDIDataType):
  ...
  uri: Annotated[Optional[AnyUrl], RdfProperty(CDI.Reference_uri,datatype=XSD.anyURI)] = None
  validType: Annotated[Optional[list[str]], RdfProperty(CDI.Reference_validType)] = None
  
class Selector (CDIDataType):
  """ Selector
...
class SpatialCoordinate (CDIDataType):
  """ SpatialCoordinate
...
class SpatialPoint (CDIDataType):
  """ SpatialPoint
...
class SpecializationRole (CDIDataType):
  """ SpecializationRole
...
class StructureSpecification (CDIDataType):
...
class WebLink (CDIDataType):
  ...
  uri: Annotated[Optional[AnyUrl], RdfProperty(CDI.WebLink_uri,datatype=XSD.anyURI)] = None
...
class AgentRelationship(CDIClass):
  """ AgentRelationship
...
class CategoryPosition(CDIClass):
  """ CategoryPosition
...
class CategoryRelationship(CDIClass):
...
class CategoryRelationStructure(CDIClass):
...
class ConceptRelationship(CDIClass):
  """ ConceptRelationship
...
class ConceptStructure(CDIClass):
  """ ConceptStructure
...
class ConceptSystemCorrespondence(CDIClass):
...
class ConceptualDomain(CDIClass):
  """ ConceptualDomain
...
class VariableCollection(CDIClass):
  """ VariableCollection
...
class VariablePosition(CDIClass):
  """ VariablePosition
...
class VariableRelationship(CDIClass):
...
class VariableStructure(CDIClass):
  """ VariableStructure
...
class ComponentPosition(CDIClass):
  """ ComponentPosition
...
class DataStructureComponent(CDIClass):
...
class ForeignKeyComponent(CDIClass):
  """ ForeignKeyComponent
...
class PrimaryKeyComponent(CDIClass):
  """ PrimaryKeyComponent
...
class DataPointPosition(CDIClass):
  """ DataPointPosition
...
class DataPointRelationship(CDIClass):
...
class InstanceVariableMap(CDIClass):
  """ InstanceVariableMap
...
class LogicalRecordPosition(CDIClass):
...
class LogicalRecordRelationship(CDIClass):
...
class LogicalRecordRelationStructure(CDIClass):
...
class PhysicalDataSet(CDIClass):
  """ PhysicalDataSet
...
class PhysicalDataSetStructure(CDIClass):
...
class PhysicalLayoutRelationStructure(CDIClass):
...
class PhysicalRecordSegment(CDIClass):
...
class PhysicalRecordSegmentPosition(CDIClass):
...
class PhysicalRecordSegmentRelationship(CDIClass):
...
class PhysicalRecordSegmentStructure(CDIClass):
...
class PhysicalSegmentLayout(CDIClass):
...
class PhysicalSegmentLocation(CDIClass):
...
class ValueMappingPosition(CDIClass):
...
class ValueMappingRelationship(CDIClass):
...
class InformationFlowDefinition(CDIClass):
...
class ProductionEnvironment(CDIClass):
...
class SequencePosition(CDIClass):
  """ SequencePosition
...
class AuthorizationSource(CDIClass):
  """ AuthorizationSource
...
class CategoryStatistic(CDIClass):
  """ CategoryStatistic
...
class ClassificationFamily(CDIClass):
...
class ClassificationIndex(CDIClass):
  """ ClassificationIndex
  ...
  availableLanguage: Annotated[Optional[list[str]], RdfProperty(CDI.ClassificationIndex_availableLanguage,datatype=XSD.language)] = None 
...
class ClassificationIndexEntry(CDIClass):
...
class ClassificationIndexEntryPosition(CDIClass):
...
class ClassificationItem(CDIClass):
  """ ClassificationItem
...
class ClassificationItemPosition(CDIClass):
...
class ClassificationItemRelationship(CDIClass):
...
class ClassificationItemStructure(CDIClass):
...
class ClassificationPosition(CDIClass):
...
class ClassificationSeries(CDIClass):
...
class ClassificationSeriesStructure(CDIClass):
...
class CodeListStructure(CDIClass):
  """ CodeListStructure
...
class CodeRelationship(CDIClass):
  """ CodeRelationship
...
class CorrespondenceTable(CDIClass):
  """ CorrespondenceTable
...
class EnumerationDomain(CDIClass):
  """ EnumerationDomain
...
class StatisticalClassificationRelationship(CDIClass):
...
class ValueAndConceptDescription(CDIClass):
...
class StatisticalClassification(EnumerationDomain):
  ...
  availableLanguage: Annotated[Optional[list[str]], RdfProperty(CDI.StatisticalClassification_availableLanguage,datatype=XSD.language)] = None 
