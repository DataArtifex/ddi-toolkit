...
from rdflib import OWL, XSD, Namespace, URIRef

from dartfx.rdf.pydantic import DefaultUriGenerator, RdfBaseModel, RdfProperty, RdfUriGenerator

CDI = Namespace("http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/")


class CDIResource(RdfBaseModel):  # type: ignore[misc]
    """Base class for DDI-CDI resources."""

    rdf_namespace = CDI
    rdf_prefixes = {"cdi": CDI}
    id: Any | None = None
    rdf_uri_generator: RdfUriGenerator = DefaultUriGenerator(auto_uuid=False)
...
class AccessInformation(CDIDataType):
    ...
    copyright: Annotated[list[InternationalString] | None, RdfProperty(CDI.AccessInformation_copyright)] = None
    embargo: Annotated[list[EmbargoInformation] | None, RdfProperty(CDI.AccessInformation_embargo)] = None
    license: Annotated[list[LicenseInformation] | None, RdfProperty(CDI.AccessInformation_license)] = None
    rights: Annotated[list[InternationalString] | None, RdfProperty(CDI.AccessInformation_rights)] = None
...
class AccessLocation(CDIDataType):
    ...
    mimeType: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.AccessLocation_mimeType)] = None
    physicalLocation: Annotated[list[InternationalString] | None, RdfProperty(CDI.AccessLocation_physicalLocation)] = (
        None
    )
    uri: Annotated[list[AnyUrl] | None, RdfProperty(CDI.AccessLocation_uri, datatype=XSD.anyURI)] = None
...
class Address(CDIDataType):
    ...
    cityPlaceLocal: Annotated[str | None, RdfProperty(CDI.Address_cityPlaceLocal)] = None
    countryCode: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Address_countryCode)] = None
    effectiveDates: Annotated[DateRange | None, RdfProperty(CDI.Address_effectiveDates)] = None
    geographicPoint: Annotated[SpatialPoint | None, RdfProperty(CDI.Address_geographicPoint)] = None
    isPreferred: Annotated[bool | None, RdfProperty(CDI.Address_isPreferred)] = None
    line: Annotated[list[str] | None, RdfProperty(CDI.Address_line)] = None
    locationName: Annotated[ObjectName | None, RdfProperty(CDI.Address_locationName)] = None
    postalCode: Annotated[str | None, RdfProperty(CDI.Address_postalCode)] = None
    privacy: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Address_privacy)] = None
    regionalCoverage: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Address_regionalCoverage)] = None
    stateProvince: Annotated[str | None, RdfProperty(CDI.Address_stateProvince)] = None
    timeZone: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Address_timeZone)] = None
    typeOfAddress: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Address_typeOfAddress)] = None
    typeOfLocation: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Address_typeOfLocation)] = None
...
class AgentInRole(CDIDataType):
    ...
    agentName: Annotated[BibliographicName | None, RdfProperty(CDI.AgentInRole_agentName)] = None
    reference: Annotated[Reference | None, RdfProperty(CDI.AgentInRole_reference)] = None
    role: Annotated[list[PairedControlledVocabularyEntry] | None, RdfProperty(CDI.AgentInRole_role)] = None
...
class CatalogDetails(CDIDataType):
    ...
    access: Annotated[list[AccessInformation] | None, RdfProperty(CDI.CatalogDetails_access)] = None
    alternativeTitle: Annotated[list[InternationalString] | None, RdfProperty(CDI.CatalogDetails_alternativeTitle)] = (
        None
    )
    contributor: Annotated[list[AgentInRole] | None, RdfProperty(CDI.CatalogDetails_contributor)] = None
    creator: Annotated[list[AgentInRole] | None, RdfProperty(CDI.CatalogDetails_creator)] = None
    date: Annotated[list[CombinedDate] | None, RdfProperty(CDI.CatalogDetails_date)] = None
    identifier: Annotated[InternationalIdentifier | None, RdfProperty(CDI.CatalogDetails_identifier)] = None
    informationSource: Annotated[
        list[InternationalString] | None, RdfProperty(CDI.CatalogDetails_informationSource)
    ] = None
    languageOfObject: Annotated[
        list[str] | None, RdfProperty(CDI.CatalogDetails_languageOfObject, datatype=XSD.language)
    ] = None
    provenance: Annotated[ProvenanceInformation | None, RdfProperty(CDI.CatalogDetails_provenance)] = None
    publisher: Annotated[list[AgentInRole] | None, RdfProperty(CDI.CatalogDetails_publisher)] = None
    relatedResource: Annotated[list[Reference] | None, RdfProperty(CDI.CatalogDetails_relatedResource)] = None
    subTitle: Annotated[list[InternationalString] | None, RdfProperty(CDI.CatalogDetails_subTitle)] = None
    summary: Annotated[InternationalString | None, RdfProperty(CDI.CatalogDetails_summary)] = None
    title: Annotated[InternationalString | None, RdfProperty(CDI.CatalogDetails_title)] = None
    typeOfResource: Annotated[
        list[ControlledVocabularyEntry] | None, RdfProperty(CDI.CatalogDetails_typeOfResource)
    ] = None
...
class CombinedDate(CDIDataType):
    ...
    isoDate: Annotated[date | None, RdfProperty(CDI.CombinedDate_isoDate)] = None
    nonIsoDate: Annotated[list[NonIsoDate] | None, RdfProperty(CDI.CombinedDate_nonIsoDate)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.CombinedDate_semantics)] = None
...
class Command(CDIDataType):
    ...
    commandContent: Annotated[TypedString | None, RdfProperty(CDI.Command_commandContent)] = None
    programLanguage: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Command_programLanguage)] = None
...
class CommandCode(CDIDataType):
    ...
    command: Annotated[list[Command] | None, RdfProperty(CDI.CommandCode_command)] = None
    commandFile: Annotated[list[CommandFile] | None, RdfProperty(CDI.CommandCode_commandFile)] = None
    description: Annotated[InternationalString | None, RdfProperty(CDI.CommandCode_description)] = None
...
class CommandFile(CDIDataType):
    ...
    location: Annotated[InternationalString | None, RdfProperty(CDI.CommandFile_location)] = None
    uri: Annotated[AnyUrl | None, RdfProperty(CDI.CommandFile_uri, datatype=XSD.anyURI)] = None
...
class ContactInformation(CDIDataType):
    ...
    address: Annotated[list[Address] | None, RdfProperty(CDI.ContactInformation_address)] = None
    email: Annotated[list[Email] | None, RdfProperty(CDI.ContactInformation_email)] = None
    emessaging: Annotated[list[ElectronicMessageSystem] | None, RdfProperty(CDI.ContactInformation_emessaging)] = None
    telephone: Annotated[list[Telephone] | None, RdfProperty(CDI.ContactInformation_telephone)] = None
    website: Annotated[list[WebLink] | None, RdfProperty(CDI.ContactInformation_website)] = None
...
class ControlledVocabularyEntry(CDIDataType):
    ...
    entryReference: Annotated[list[Reference] | None, RdfProperty(CDI.ControlledVocabularyEntry_entryReference)] = None
    entryValue: Annotated[list[str] | None, RdfProperty(CDI.ControlledVocabularyEntry_entryValue)] = None
    name: Annotated[str | None, RdfProperty(CDI.ControlledVocabularyEntry_name)] = None
    valueForOther: Annotated[str | None, RdfProperty(CDI.ControlledVocabularyEntry_valueForOther)] = None
    vocabulary: Annotated[Reference | None, RdfProperty(CDI.ControlledVocabularyEntry_vocabulary)] = None
...
class CorrespondenceDefinition(CDIDataType):
    ...
    commonality: Annotated[InternationalString | None, RdfProperty(CDI.CorrespondenceDefinition_commonality)] = None
    commonalityCode: Annotated[
        list[ControlledVocabularyEntry] | None, RdfProperty(CDI.CorrespondenceDefinition_commonalityCode)
    ] = None
    difference: Annotated[InternationalString | None, RdfProperty(CDI.CorrespondenceDefinition_difference)] = None
    matching: Annotated[MatchingCriterion | None, RdfProperty(CDI.CorrespondenceDefinition_matching)] = None
...
class DateRange(CDIDataType):
    ...
    endDate: Annotated[CombinedDate | None, RdfProperty(CDI.DateRange_endDate)] = None
    startDate: Annotated[CombinedDate | None, RdfProperty(CDI.DateRange_startDate)] = None
...
class ElectronicMessageSystem(CDIDataType):
    ...
    contactAddress: Annotated[str | None, RdfProperty(CDI.ElectronicMessageSystem_contactAddress)] = None
    effectiveDates: Annotated[DateRange | None, RdfProperty(CDI.ElectronicMessageSystem_effectiveDates)] = None
    isPreferred: Annotated[bool | None, RdfProperty(CDI.ElectronicMessageSystem_isPreferred)] = None
    privacy: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ElectronicMessageSystem_privacy)] = None
    typeOfService: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.ElectronicMessageSystem_typeOfService)
    ] = None
...
class Email(CDIDataType):
    ...
    effectiveDates: Annotated[DateRange | None, RdfProperty(CDI.Email_effectiveDates)] = None
    internetEmail: Annotated[str | None, RdfProperty(CDI.Email_internetEmail)] = None
    isPreferred: Annotated[bool | None, RdfProperty(CDI.Email_isPreferred)] = None
    privacy: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Email_privacy)] = None
    typeOfEmail: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Email_typeOfEmail)] = None
...
class EmbargoInformation(CDIDataType):
    ...
    description: Annotated[InternationalString | None, RdfProperty(CDI.EmbargoInformation_description)] = None
    period: Annotated[list[DateRange] | None, RdfProperty(CDI.EmbargoInformation_period)] = None
...
class FundingInformation(CDIDataType):
    ...
    fundingAgent: Annotated[list[AgentInRole] | None, RdfProperty(CDI.FundingInformation_fundingAgent)] = None
    grantNumber: Annotated[str | None, RdfProperty(CDI.FundingInformation_grantNumber)] = None
...
class Identifier(CDIDataType):
    ...
    ddiIdentifier: Annotated[
        InternationalRegistrationDataIdentifier | None, RdfProperty(CDI.Identifier_ddiIdentifier)
    ] = None
    isDdiIdentifierPersistent: Annotated[bool | None, RdfProperty(CDI.Identifier_isDdiIdentifierPersistent)] = None
    isDdiIdentifierUniversallyUnique: Annotated[
        bool | None, RdfProperty(CDI.Identifier_isDdiIdentifierUniversallyUnique)
    ] = None
    nonDdiIdentifier: Annotated[list[NonDdiIdentifier] | None, RdfProperty(CDI.Identifier_nonDdiIdentifier)] = None
    uri: Annotated[AnyUrl | None, RdfProperty(CDI.Identifier_uri, datatype=XSD.anyURI)] = None
    versionDate: Annotated[date | None, RdfProperty(CDI.Identifier_versionDate)] = None
    versionRationale: Annotated[RationaleDefinition | None, RdfProperty(CDI.Identifier_versionRationale)] = None
    versionResponsibility: Annotated[AgentInRole | None, RdfProperty(CDI.Identifier_versionResponsibility)] = None
...
class IndividualName(CDIDataType):
    ...
    abbreviation: Annotated[InternationalString | None, RdfProperty(CDI.IndividualName_abbreviation)] = None
    context: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.IndividualName_context)] = None
    effectiveDates: Annotated[DateRange | None, RdfProperty(CDI.IndividualName_effectiveDates)] = None
    firstGiven: Annotated[str | None, RdfProperty(CDI.IndividualName_firstGiven)] = None
    fullName: Annotated[InternationalString | None, RdfProperty(CDI.IndividualName_fullName)] = None
    isFormal: Annotated[bool | None, RdfProperty(CDI.IndividualName_isFormal)] = None
    isPreferred: Annotated[bool | None, RdfProperty(CDI.IndividualName_isPreferred)] = None
    lastFamily: Annotated[str | None, RdfProperty(CDI.IndividualName_lastFamily)] = None
    middle: Annotated[list[str] | None, RdfProperty(CDI.IndividualName_middle)] = None
    prefix: Annotated[str | None, RdfProperty(CDI.IndividualName_prefix)] = None
    sex: Annotated[SexSpecification | None, RdfProperty(CDI.IndividualName_sex)] = None
    suffix: Annotated[str | None, RdfProperty(CDI.IndividualName_suffix)] = None
    typeOfIndividualName: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.IndividualName_typeOfIndividualName)
    ] = None
...
class InternationalIdentifier(CDIDataType):
    ...
    identifierContent: Annotated[str | None, RdfProperty(CDI.InternationalIdentifier_identifierContent)] = None
    isURI: Annotated[bool | None, RdfProperty(CDI.InternationalIdentifier_isURI)] = None
    managingAgency: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.InternationalIdentifier_managingAgency)
    ] = None
...
class InternationalRegistrationDataIdentifier(CDIDataType):
    ...
    registrationAuthorityIdentifier: Annotated[
        str, RdfProperty(CDI.InternationalRegistrationDataIdentifier_registrationAuthorityIdentifier)
    ]
...
class InternationalString(CDIDataType):
    ...
    languageSpecificString: Annotated[
        list[LanguageString] | None, RdfProperty(CDI.InternationalString_languageSpecificString)
    ] = None
...
class LanguageString(CDIDataType):
    ...
    isTranslatable: Annotated[bool | None, RdfProperty(CDI.LanguageString_isTranslatable)] = None
    isTranslated: Annotated[bool | None, RdfProperty(CDI.LanguageString_isTranslated)] = None
    language: Annotated[str | None, RdfProperty(CDI.LanguageString_language, datatype=XSD.language)] = None
    scope: Annotated[str | None, RdfProperty(CDI.LanguageString_scope)] = None
    structureUsed: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.LanguageString_structureUsed)] = None
    translationDate: Annotated[date | None, RdfProperty(CDI.LanguageString_translationDate)] = None
    translationSourceLanguage: Annotated[
        list[str] | None, RdfProperty(CDI.LanguageString_translationSourceLanguage, datatype=XSD.language)
    ] = None
...
class LicenseInformation(CDIDataType):
    ...
    contact: Annotated[list[ContactInformation] | None, RdfProperty(CDI.LicenseInformation_contact)] = None
    description: Annotated[list[InternationalString] | None, RdfProperty(CDI.LicenseInformation_description)] = None
    licenseAgent: Annotated[list[AgentInRole] | None, RdfProperty(CDI.LicenseInformation_licenseAgent)] = None
    licenseReference: Annotated[list[Reference] | None, RdfProperty(CDI.LicenseInformation_licenseReference)] = None
...
class NonDdiIdentifier(CDIDataType):
    ...
    managingAgency: Annotated[str | None, RdfProperty(CDI.NonDdiIdentifier_managingAgency)] = None
    type: Annotated[str, RdfProperty(CDI.NonDdiIdentifier_type)]
    value: Annotated[str, RdfProperty(CDI.NonDdiIdentifier_value)]
    version: Annotated[str | None, RdfProperty(CDI.NonDdiIdentifier_version)] = None
...
class NonIsoDate(CDIDataType):
    ...
    calendar: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.NonIsoDate_calendar)] = None
    dateContent: Annotated[str, RdfProperty(CDI.NonIsoDate_dateContent)]
    nonIsoDateFormat: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.NonIsoDate_nonIsoDateFormat)] = None
...
class ObjectName(CDIDataType):
    ...
    context: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ObjectName_context)] = None
    name: Annotated[str | None, RdfProperty(CDI.ObjectName_name)] = None
...
class PairedControlledVocabularyEntry(CDIDataType):
    ...
    extent: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.PairedControlledVocabularyEntry_extent)] = None
...
class PrivateImage(CDIDataType):
    ...
    effectiveDates: Annotated[DateRange | None, RdfProperty(CDI.PrivateImage_effectiveDates)] = None
    privacy: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.PrivateImage_privacy)] = None
...
class ProvenanceInformation(CDIDataType):
    ...
    funding: Annotated[list[FundingInformation] | None, RdfProperty(CDI.ProvenanceInformation_funding)] = None
    provenanceStatement: Annotated[
        list[InternationalString] | None, RdfProperty(CDI.ProvenanceInformation_provenanceStatement)
    ] = None
    recordCreationDate: Annotated[date | None, RdfProperty(CDI.ProvenanceInformation_recordCreationDate)] = None
    recordLastRevisionDate: Annotated[date | None, RdfProperty(CDI.ProvenanceInformation_recordLastRevisionDate)] = None
...
class RationaleDefinition(CDIDataType):
    ...
    rationaleCode: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.RationaleDefinition_rationaleCode)] = (
        None
    )
    rationaleDescription: Annotated[
        InternationalString | None, RdfProperty(CDI.RationaleDefinition_rationaleDescription)
    ] = None
...
class Reference(CDIDataType):
    ...
    ddiReference: Annotated[InternationalRegistrationDataIdentifier | None, RdfProperty(CDI.Reference_ddiReference)] = (
        None
    )
    deepLink: Annotated[Selector | None, RdfProperty(CDI.Reference_deepLink)] = None
    description: Annotated[str | None, RdfProperty(CDI.Reference_description)] = None
    location: Annotated[InternationalString | None, RdfProperty(CDI.Reference_location)] = None
    nonDdiReference: Annotated[list[NonDdiIdentifier] | None, RdfProperty(CDI.Reference_nonDdiReference)] = None
    semantic: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Reference_semantic)] = None
    uri: Annotated[AnyUrl | None, RdfProperty(CDI.Reference_uri, datatype=XSD.anyURI)] = None
    validType: Annotated[list[str] | None, RdfProperty(CDI.Reference_validType)] = None
...
class SpatialCoordinate(CDIDataType):
    ...
    content: Annotated[str | None, RdfProperty(CDI.SpatialCoordinate_content)] = None
    coordinateType: Annotated[PointFormat | None, RdfProperty(CDI.SpatialCoordinate_coordinateType)] = None
...
class SpatialPoint(CDIDataType):
    ...
    xCoordinate: Annotated[SpatialCoordinate | None, RdfProperty(CDI.SpatialPoint_xCoordinate)] = None
    yCoordinate: Annotated[SpatialCoordinate | None, RdfProperty(CDI.SpatialPoint_yCoordinate)] = None
...
class Statistic(CDIDataType):
    ...
    computationBase: Annotated[ComputationBaseList | None, RdfProperty(CDI.Statistic_computationBase)] = None
    content: Annotated[float | None, RdfProperty(CDI.Statistic_content)] = None
    isWeighted: Annotated[bool | None, RdfProperty(CDI.Statistic_isWeighted)] = None
    typeOfNumericValue: Annotated[str | None, RdfProperty(CDI.Statistic_typeOfNumericValue)] = None
...
class StructureSpecification(CDIDataType):
    ...
    reflexive: Annotated[MemberRelationshipScope | None, RdfProperty(CDI.StructureSpecification_reflexive)] = None
    symmetric: Annotated[MemberRelationshipScope | None, RdfProperty(CDI.StructureSpecification_symmetric)] = None
    transitive: Annotated[MemberRelationshipScope | None, RdfProperty(CDI.StructureSpecification_transitive)] = None
...
class Telephone(CDIDataType):
    ...
    effectiveDates: Annotated[DateRange | None, RdfProperty(CDI.Telephone_effectiveDates)] = None
    isPreferred: Annotated[bool | None, RdfProperty(CDI.Telephone_isPreferred)] = None
    privacy: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Telephone_privacy)] = None
    telephoneNumber: Annotated[str | None, RdfProperty(CDI.Telephone_telephoneNumber)] = None
    typeOfTelephone: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Telephone_typeOfTelephone)] = None
...
class TypedString(CDIDataType):
    ...
    typeOfContent: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.TypedString_typeOfContent)] = None
...
class WebLink(CDIDataType):
    ...
    effectiveDates: Annotated[DateRange | None, RdfProperty(CDI.WebLink_effectiveDates)] = None
    isPreferred: Annotated[bool | None, RdfProperty(CDI.WebLink_isPreferred)] = None
    privacy: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.WebLink_privacy)] = None
    typeOfWebsite: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.WebLink_typeOfWebsite)] = None
    uri: Annotated[AnyUrl | None, RdfProperty(CDI.WebLink_uri, datatype=XSD.anyURI)] = None
...
class BibliographicName(InternationalString):
    ...
    affiliation: Annotated[str | None, RdfProperty(CDI.BibliographicName_affiliation)] = None
...
class LabelForDisplay(InternationalString):
    ...
    locationVariant: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.LabelForDisplay_locationVariant)] = (
        None
    )
    maxLength: Annotated[int | None, RdfProperty(CDI.LabelForDisplay_maxLength)] = None
    validDates: Annotated[DateRange | None, RdfProperty(CDI.LabelForDisplay_validDates)] = None
...
class OrganizationName(ObjectName):
    ...
    abbreviation: Annotated[InternationalString | None, RdfProperty(CDI.OrganizationName_abbreviation)] = None
    effectiveDates: Annotated[DateRange | None, RdfProperty(CDI.OrganizationName_effectiveDates)] = None
    isFormal: Annotated[bool | None, RdfProperty(CDI.OrganizationName_isFormal)] = None
    typeOfOrganizationName: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.OrganizationName_typeOfOrganizationName)
    ] = None
...
class ObjectAttributeSelector(Selector):
    ...
    refinedBy: Annotated[ObjectAttributeSelector | None, RdfProperty(CDI.ObjectAttributeSelector_refinedBy)] = None
    refinedByOrderNumber: Annotated[int | None, RdfProperty(CDI.ObjectAttributeSelector_refinedByOrderNumber)] = None
    value: Annotated[str | None, RdfProperty(CDI.ObjectAttributeSelector_value)] = None
...
class GeoRole(SpecializationRole):
    ...
    geography: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.GeoRole_geography)] = None
...
class TimeRole(SpecializationRole):
    ...
    time: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.TimeRole_time)] = None
...
class Agent(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.Agent_catalogDetails)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Agent_identifier)] = None
    image: Annotated[list[PrivateImage] | None, RdfProperty(CDI.Agent_image)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.Agent_purpose)] = None
...
class AgentListing(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.AgentListing_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.AgentListing_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.AgentListing_purpose)] = None

    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.AgentListing_isDefinedBy_Concept)] = None
    isMaintainedBy: Annotated[URIRef | None, RdfProperty(CDI.AgentListing_isMaintainedBy_Agent)] = None
    has_AgentPosition: Annotated[list[URIRef] | None, RdfProperty(CDI.AgentListing_has_AgentPosition)] = None
    has_Agent: Annotated[list[URIRef] | None, RdfProperty(CDI.AgentListing_has_Agent)] = None
...
class AgentPosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.AgentPosition_identifier)] = None
    value: Annotated[int, RdfProperty(CDI.AgentPosition_value)]

    indexes: Annotated[URIRef | None, RdfProperty(CDI.AgentPosition_indexes_Agent)] = None
...
class AgentRelationship(CDIClass):
    ...
    effectiveDates: Annotated[DateRange | None, RdfProperty(CDI.AgentRelationship_effectiveDates)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.AgentRelationship_identifier)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.AgentRelationship_semantics)] = None
...
class AgentStructure(CDIClass):
    ...
    effectiveDates: Annotated[DateRange | None, RdfProperty(CDI.AgentStructure_effectiveDates)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.AgentStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.AgentStructure_name)] = None
    privacy: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.AgentStructure_privacy)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.AgentStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.AgentStructure_semantics)] = None
    specification: Annotated[StructureSpecification | None, RdfProperty(CDI.AgentStructure_specification)] = None
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.AgentStructure_topology)] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.AgentStructure_totality)] = None

    structures: Annotated[URIRef | None, RdfProperty(CDI.AgentStructure_structures_AgentListing)] = None
    has_AgentRelationship: Annotated[list[URIRef] | None, RdfProperty(CDI.AgentStructure_has_AgentRelationship)] = None
...
class CategoryPosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.CategoryPosition_identifier)] = None
...
class CategoryRelationship(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.CategoryRelationship_identifier)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.CategoryRelationship_semantics)] = None

    hasSource: Annotated[list[URIRef] | None, RdfProperty(CDI.CategoryRelationship_hasSource_Category)] = None
    hasTarget: Annotated[list[URIRef] | None, RdfProperty(CDI.CategoryRelationship_hasTarget_Category)] = None
...
class CategoryRelationStructure(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.CategoryRelationStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.CategoryRelationStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.CategoryRelationStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.CategoryRelationStructure_semantics)] = None
    specification: Annotated[
        StructureSpecification | None, RdfProperty(CDI.CategoryRelationStructure_specification)
    ] = None
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.CategoryRelationStructure_topology)] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.CategoryRelationStructure_totality)] = None

    structures: Annotated[URIRef | None, RdfProperty(CDI.CategoryRelationStructure_structures_CategorySet)] = None
    has_CategoryRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.CategoryRelationStructure_has_CategoryRelationship)
    ] = None
...
class Concept(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.Concept_catalogDetails)] = None
    definition: Annotated[InternationalString | None, RdfProperty(CDI.Concept_definition)] = None
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.Concept_displayLabel)] = None
    externalDefinition: Annotated[Reference | None, RdfProperty(CDI.Concept_externalDefinition)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Concept_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.Concept_name)] = None
    sameAs: Annotated[URIRef | None, RdfProperty(OWL.sameAs)] = None

    uses_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.Concept_uses_Concept)] = None
...
class ConceptMap(CDIClass):
    ...
    correspondence: Annotated[CorrespondenceDefinition | None, RdfProperty(CDI.ConceptMap_correspondence)] = None
    displayLabel: Annotated[LabelForDisplay | None, RdfProperty(CDI.ConceptMap_displayLabel)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ConceptMap_identifier)] = None
    usage: Annotated[InternationalString | None, RdfProperty(CDI.ConceptMap_usage)] = None
    validDates: Annotated[DateRange | None, RdfProperty(CDI.ConceptMap_validDates)] = None
...
class ConceptRelationship(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ConceptRelationship_identifier)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ConceptRelationship_semantics)] = None
...
class ConceptStructure(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ConceptStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ConceptStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.ConceptStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ConceptStructure_semantics)] = None
    specification: Annotated[StructureSpecification | None, RdfProperty(CDI.ConceptStructure_specification)] = None
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ConceptStructure_topology)] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.ConceptStructure_totality)] = None

    structures: Annotated[URIRef | None, RdfProperty(CDI.ConceptStructure_structures_ConceptSystem)] = None
    has_ConceptRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ConceptStructure_has_ConceptRelationship)
    ] = None
...
class ConceptSystem(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.ConceptSystem_catalogDetails)] = None
    externalDefinition: Annotated[Reference | None, RdfProperty(CDI.ConceptSystem_externalDefinition)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ConceptSystem_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ConceptSystem_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.ConceptSystem_purpose)] = None

    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.ConceptSystem_isDefinedBy_Concept)] = None
    has_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.ConceptSystem_has_Concept)] = None
...
class ConceptSystemCorrespondence(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.ConceptSystemCorrespondence_catalogDetails)] = None
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.ConceptSystemCorrespondence_displayLabel)] = (
        None
    )
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ConceptSystemCorrespondence_identifier)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.ConceptSystemCorrespondence_purpose)] = None
    usage: Annotated[InternationalString | None, RdfProperty(CDI.ConceptSystemCorrespondence_usage)] = None

    maps: Annotated[list[URIRef], RdfProperty(CDI.ConceptSystemCorrespondence_maps_ConceptSystem)]
    has_ConceptMap: Annotated[list[URIRef] | None, RdfProperty(CDI.ConceptSystemCorrespondence_has_ConceptMap)] = None
...
class ConceptualDomain(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.ConceptualDomain_catalogDetails)] = None
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.ConceptualDomain_displayLabel)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ConceptualDomain_identifier)] = None

    isDescribedBy: Annotated[
        URIRef | None, RdfProperty(CDI.ConceptualDomain_isDescribedBy_ValueAndConceptDescription)
    ] = None
    takesConceptsFrom: Annotated[URIRef | None, RdfProperty(CDI.ConceptualDomain_takesConceptsFrom_ConceptSystem)] = (
        None
    )
...
class Unit(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.Unit_catalogDetails)] = None
    definition: Annotated[InternationalString | None, RdfProperty(CDI.Unit_definition)] = None
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.Unit_displayLabel)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Unit_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.Unit_name)] = None

    has_UnitType: Annotated[list[URIRef] | None, RdfProperty(CDI.Unit_has_UnitType)] = None
...
class VariableCollection(CDIClass):
    ...
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.VariableCollection_displayLabel)] = None
    groupingSemantic: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.VariableCollection_groupingSemantic)
    ] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.VariableCollection_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.VariableCollection_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.VariableCollection_purpose)] = None
    usage: Annotated[InternationalString | None, RdfProperty(CDI.VariableCollection_usage)] = None

    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.VariableCollection_isDefinedBy_Concept)] = None
    has_ConceptualVariable: Annotated[
        list[URIRef] | None, RdfProperty(CDI.VariableCollection_has_ConceptualVariable)
    ] = None
    has_VariablePosition: Annotated[list[URIRef] | None, RdfProperty(CDI.VariableCollection_has_VariablePosition)] = (
        None
    )
...
class VariablePosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.VariablePosition_identifier)] = None
...
class VariableRelationship(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.VariableRelationship_identifier)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.VariableRelationship_semantics)] = None

    hasTarget: Annotated[list[URIRef] | None, RdfProperty(CDI.VariableRelationship_hasTarget_ConceptualVariable)] = None
    hasSource: Annotated[list[URIRef] | None, RdfProperty(CDI.VariableRelationship_hasSource_ConceptualVariable)] = None
...
class VariableStructure(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.VariableStructure_identifier)] = None
    name: Annotated[list[OrganizationName] | None, RdfProperty(CDI.VariableStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.VariableStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.VariableStructure_semantics)] = None
    specification: Annotated[StructureSpecification | None, RdfProperty(CDI.VariableStructure_specification)] = None
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.VariableStructure_topology)] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.VariableStructure_totality)] = None

    structures: Annotated[URIRef | None, RdfProperty(CDI.VariableStructure_structures_VariableCollection)] = None
    has_VariableRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.VariableStructure_has_VariableRelationship)
    ] = None
...
class DataPoint(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.DataPoint_catalogDetails)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.DataPoint_identifier)] = None

    correspondsTo_DataStructureComponent: Annotated[
        list[URIRef] | None, RdfProperty(CDI.DataPoint_correspondsTo_DataStructureComponent)
    ] = None
...
class DataSet(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.DataSet_catalogDetails)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.DataSet_identifier)] = None

    isStructuredBy: Annotated[list[URIRef] | None, RdfProperty(CDI.DataSet_isStructuredBy_DataStructure)] = None
    has_DataPoint: Annotated[list[URIRef] | None, RdfProperty(CDI.DataSet_has_DataPoint)] = None
    has_Key: Annotated[list[URIRef] | None, RdfProperty(CDI.DataSet_has_Key)] = None
...
class Datum(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.Datum_catalogDetails)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Datum_identifier)] = None

    uses_Notation: Annotated[URIRef | None, RdfProperty(CDI.Datum_uses_Notation)] = None
...
class InstanceValue(CDIClass):
    ...
    content: Annotated[TypedString | None, RdfProperty(CDI.InstanceValue_content)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.InstanceValue_identifier)] = None
    whiteSpace: Annotated[WhiteSpaceRule | None, RdfProperty(CDI.InstanceValue_whiteSpace)] = None

    hasValueFrom_ValueDomain: Annotated[URIRef, RdfProperty(CDI.InstanceValue_hasValueFrom_ValueDomain)]
    isStoredIn: Annotated[URIRef | None, RdfProperty(CDI.InstanceValue_isStoredIn_DataPoint)] = None
    represents: Annotated[URIRef | None, RdfProperty(CDI.InstanceValue_represents_ConceptualValue)] = None
...
class Key(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Key_identifier)] = None

    correspondsTo_Unit: Annotated[URIRef | None, RdfProperty(CDI.Key_correspondsTo_Unit)] = None
    represents: Annotated[URIRef | None, RdfProperty(CDI.Key_represents_KeyDefinition)] = None
    identifies: Annotated[list[URIRef], RdfProperty(CDI.Key_identifies_DataPoint)]
    correspondsTo_Universe: Annotated[URIRef | None, RdfProperty(CDI.Key_correspondsTo_Universe)] = None
    has_KeyMember: Annotated[list[URIRef] | None, RdfProperty(CDI.Key_has_KeyMember)] = None
...
class KeyDefinition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.KeyDefinition_identifier)] = None

    correspondsTo_Universe: Annotated[URIRef | None, RdfProperty(CDI.KeyDefinition_correspondsTo_Universe)] = None
    correspondsTo_Unit: Annotated[URIRef | None, RdfProperty(CDI.KeyDefinition_correspondsTo_Unit)] = None
    has_KeyDefinitionMember: Annotated[list[URIRef] | None, RdfProperty(CDI.KeyDefinition_has_KeyDefinitionMember)] = (
        None
    )
...
class Notation(CDIClass):
    ...
    content: Annotated[TypedString | None, RdfProperty(CDI.Notation_content)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Notation_identifier)] = None
    whiteSpace: Annotated[WhiteSpaceRule | None, RdfProperty(CDI.Notation_whiteSpace)] = None

    represents: Annotated[list[URIRef] | None, RdfProperty(CDI.Notation_represents_Category)] = None
...
class ComponentPosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ComponentPosition_identifier)] = None
    value: Annotated[int, RdfProperty(CDI.ComponentPosition_value)]

    indexes: Annotated[URIRef | None, RdfProperty(CDI.ComponentPosition_indexes_DataStructureComponent)] = None
...
class DataStructureComponent(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.DataStructureComponent_identifier)] = None
    semantic: Annotated[
        list[PairedControlledVocabularyEntry] | None, RdfProperty(CDI.DataStructureComponent_semantic)
    ] = None
    specialization: Annotated[SpecializationRole | None, RdfProperty(CDI.DataStructureComponent_specialization)] = None

    isDefinedBy_RepresentedVariable: Annotated[
        URIRef | None, RdfProperty(CDI.DataStructureComponent_isDefinedBy_RepresentedVariable)
    ] = None
...
class ForeignKey(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ForeignKey_identifier)] = None
...
class ForeignKeyComponent(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ForeignKeyComponent_identifier)] = None

    references: Annotated[URIRef, RdfProperty(CDI.ForeignKeyComponent_references_PrimaryKeyComponent)]
    correspondsTo_DataStructureComponent: Annotated[
        URIRef, RdfProperty(CDI.ForeignKeyComponent_correspondsTo_DataStructureComponent)
    ]
...
class PrimaryKey(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PrimaryKey_identifier)] = None
...
class PrimaryKeyComponent(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PrimaryKeyComponent_identifier)] = None

    correspondsTo_DataStructureComponent: Annotated[
        URIRef, RdfProperty(CDI.PrimaryKeyComponent_correspondsTo_DataStructureComponent)
    ]
...
class DimensionGroup(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.DimensionGroup_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.DimensionGroup_name)] = None
...
class Revision(CDIClass):
    ...
    algorithm: Annotated[str | None, RdfProperty(CDI.Revision_algorithm)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Revision_identifier)] = None
    overview: Annotated[InternationalString | None, RdfProperty(CDI.Revision_overview)] = None
...
class ScopedMeasure(CDIClass):
    ...
    frequency: Annotated[InternationalString | None, RdfProperty(CDI.ScopedMeasure_frequency)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ScopedMeasure_identifier)] = None

    circumscribes: Annotated[URIRef | None, RdfProperty(CDI.ScopedMeasure_circumscribes_DimensionalKeyDefinition)] = (
        None
    )
    restricts: Annotated[URIRef | None, RdfProperty(CDI.ScopedMeasure_restricts_QualifiedMeasure)] = None
...
class DataPointPosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.DataPointPosition_identifier)] = None
    value: Annotated[int, RdfProperty(CDI.DataPointPosition_value)]

    indexes: Annotated[URIRef | None, RdfProperty(CDI.DataPointPosition_indexes_DataPoint)] = None
...
class DataPointRelationship(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.DataPointRelationship_identifier)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.DataPointRelationship_semantics)] = None

    hasTarget: Annotated[list[URIRef] | None, RdfProperty(CDI.DataPointRelationship_hasTarget_DataPoint)] = None
    hasSource: Annotated[list[URIRef] | None, RdfProperty(CDI.DataPointRelationship_hasSource_DataPoint)] = None
...
class DataStore(CDIClass):
    ...
    aboutMissing: Annotated[InternationalString | None, RdfProperty(CDI.DataStore_aboutMissing)] = None
    allowsDuplicates: Annotated[bool, RdfProperty(CDI.DataStore_allowsDuplicates)]
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.DataStore_catalogDetails)] = None
    characterSet: Annotated[str | None, RdfProperty(CDI.DataStore_characterSet)] = None
    dataStoreType: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.DataStore_dataStoreType)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.DataStore_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.DataStore_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.DataStore_purpose)] = None
    recordCount: Annotated[int | None, RdfProperty(CDI.DataStore_recordCount)] = None

    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.DataStore_isDefinedBy_Concept)] = None
    has_LogicalRecordPosition: Annotated[list[URIRef] | None, RdfProperty(CDI.DataStore_has_LogicalRecordPosition)] = (
        None
    )
    has_LogicalRecord: Annotated[list[URIRef] | None, RdfProperty(CDI.DataStore_has_LogicalRecord)] = None
    has_RecordRelation: Annotated[URIRef | None, RdfProperty(CDI.DataStore_has_RecordRelation)] = None
...
class InstanceVariableMap(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.InstanceVariableMap_identifier)] = None
    setValue: Annotated[str, RdfProperty(CDI.InstanceVariableMap_setValue)]

    hasTarget: Annotated[list[URIRef] | None, RdfProperty(CDI.InstanceVariableMap_hasTarget_InstanceVariable)] = None
...
class LogicalRecord(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.LogicalRecord_identifier)] = None

    organizes: Annotated[list[URIRef] | None, RdfProperty(CDI.LogicalRecord_organizes_DataSet)] = None
    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.LogicalRecord_isDefinedBy_Concept)] = None
    has_InstanceVariable: Annotated[list[URIRef] | None, RdfProperty(CDI.LogicalRecord_has_InstanceVariable)] = None
...
class LogicalRecordPosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.LogicalRecordPosition_identifier)] = None
...
class LogicalRecordRelationship(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.LogicalRecordRelationship_identifier)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.LogicalRecordRelationship_semantics)] = None

    hasTarget: Annotated[list[URIRef] | None, RdfProperty(CDI.LogicalRecordRelationship_hasTarget_LogicalRecord)] = None
    hasSource: Annotated[list[URIRef] | None, RdfProperty(CDI.LogicalRecordRelationship_hasSource_LogicalRecord)] = None
...
class LogicalRecordRelationStructure(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.LogicalRecordRelationStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.LogicalRecordRelationStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.LogicalRecordRelationStructure_purpose)] = None
    semantics: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.LogicalRecordRelationStructure_semantics)
    ] = None
    specification: Annotated[
        StructureSpecification | None, RdfProperty(CDI.LogicalRecordRelationStructure_specification)
    ] = None
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.LogicalRecordRelationStructure_topology)] = (
        None
    )
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.LogicalRecordRelationStructure_totality)] = None

    structures: Annotated[list[URIRef] | None, RdfProperty(CDI.LogicalRecordRelationStructure_structures_DataStore)] = (
        None
    )
    has_LogicalRecordRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.LogicalRecordRelationStructure_has_LogicalRecordRelationship)
    ] = None
...
class PhysicalDataSet(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.PhysicalDataSet_catalogDetails)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PhysicalDataSet_identifier)] = None
    name: Annotated[ObjectName | None, RdfProperty(CDI.PhysicalDataSet_name)] = None
    numberOfSegments: Annotated[int | None, RdfProperty(CDI.PhysicalDataSet_numberOfSegments)] = None
    overview: Annotated[InternationalString | None, RdfProperty(CDI.PhysicalDataSet_overview)] = None
    physicalFileName: Annotated[str | None, RdfProperty(CDI.PhysicalDataSet_physicalFileName)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.PhysicalDataSet_purpose)] = None

    correspondsTo_DataSet: Annotated[URIRef | None, RdfProperty(CDI.PhysicalDataSet_correspondsTo_DataSet)] = None
    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalDataSet_isDefinedBy_Concept)] = None
    formats: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalDataSet_formats_DataStore)] = None
    has_InstanceVariable: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalDataSet_has_InstanceVariable)] = None
    has_PhysicalRecordSegment: Annotated[
        list[URIRef] | None, RdfProperty(CDI.PhysicalDataSet_has_PhysicalRecordSegment)
    ] = None
    has_PhysicalRecordSegmentPosition: Annotated[
        list[URIRef] | None, RdfProperty(CDI.PhysicalDataSet_has_PhysicalRecordSegmentPosition)
    ] = None
...
class PhysicalDataSetStructure(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PhysicalDataSetStructure_identifier)] = None
    name: Annotated[ObjectName | None, RdfProperty(CDI.PhysicalDataSetStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.PhysicalDataSetStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.PhysicalDataSetStructure_semantics)] = None
    specification: Annotated[StructureSpecification | None, RdfProperty(CDI.PhysicalDataSetStructure_specification)] = (
        None
    )
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.PhysicalDataSetStructure_topology)] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.PhysicalDataSetStructure_totality)] = None

    correspondsTo_DataStructure: Annotated[
        URIRef | None, RdfProperty(CDI.PhysicalDataSetStructure_correspondsTo_DataStructure)
    ] = None
    structures: Annotated[URIRef | None, RdfProperty(CDI.PhysicalDataSetStructure_structures_PhysicalDataSet)] = None
    has_PhysicalRecordSegmentRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.PhysicalDataSetStructure_has_PhysicalRecordSegmentRelationship)
    ] = None
...
class PhysicalLayoutRelationStructure(CDIClass):
    ...
    criteria: Annotated[InternationalString | None, RdfProperty(CDI.PhysicalLayoutRelationStructure_criteria)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PhysicalLayoutRelationStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.PhysicalLayoutRelationStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.PhysicalLayoutRelationStructure_purpose)] = None
    semantics: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.PhysicalLayoutRelationStructure_semantics)
    ] = None
    specification: Annotated[
        StructureSpecification | None, RdfProperty(CDI.PhysicalLayoutRelationStructure_specification)
    ] = None
    topology: Annotated[ControlledVocabularyEntry, RdfProperty(CDI.PhysicalLayoutRelationStructure_topology)]
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.PhysicalLayoutRelationStructure_totality)] = None

    structures: Annotated[
        URIRef | None, RdfProperty(CDI.PhysicalLayoutRelationStructure_structures_PhysicalSegmentLayout)
    ] = None
    has_ValueMappingRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.PhysicalLayoutRelationStructure_has_ValueMappingRelationship)
    ] = None
...
class PhysicalRecordSegment(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.PhysicalRecordSegment_catalogDetails)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PhysicalRecordSegment_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.PhysicalRecordSegment_name)] = None
    physicalFileName: Annotated[str | None, RdfProperty(CDI.PhysicalRecordSegment_physicalFileName)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.PhysicalRecordSegment_purpose)] = None

    represents: Annotated[URIRef | None, RdfProperty(CDI.PhysicalRecordSegment_represents_Population)] = None
    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalRecordSegment_isDefinedBy_Concept)] = (
        None
    )
    has_PhysicalSegmentLayout: Annotated[
        URIRef | None, RdfProperty(CDI.PhysicalRecordSegment_has_PhysicalSegmentLayout)
    ] = None
    mapsTo: Annotated[URIRef | None, RdfProperty(CDI.PhysicalRecordSegment_mapsTo_LogicalRecord)] = None
    has_DataPointPosition: Annotated[
        list[URIRef] | None, RdfProperty(CDI.PhysicalRecordSegment_has_DataPointPosition)
    ] = None
    has_DataPoint: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalRecordSegment_has_DataPoint)] = None
...
class PhysicalRecordSegmentPosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PhysicalRecordSegmentPosition_identifier)] = None
...
class PhysicalRecordSegmentRelationship(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PhysicalRecordSegmentRelationship_identifier)] = None
    semantics: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.PhysicalRecordSegmentRelationship_semantics)
    ] = None

    hasTarget: Annotated[
        list[URIRef] | None, RdfProperty(CDI.PhysicalRecordSegmentRelationship_hasTarget_PhysicalRecordSegment)
    ] = None
    hasSource: Annotated[
        URIRef | None, RdfProperty(CDI.PhysicalRecordSegmentRelationship_hasSource_PhysicalRecordSegment)
    ] = None
...
class PhysicalRecordSegmentStructure(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PhysicalRecordSegmentStructure_identifier)] = None
    name: Annotated[ObjectName | None, RdfProperty(CDI.PhysicalRecordSegmentStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.PhysicalRecordSegmentStructure_purpose)] = None
    semantics: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.PhysicalRecordSegmentStructure_semantics)
    ] = None
    specification: Annotated[
        StructureSpecification | None, RdfProperty(CDI.PhysicalRecordSegmentStructure_specification)
    ] = None
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.PhysicalRecordSegmentStructure_topology)] = (
        None
    )
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.PhysicalRecordSegmentStructure_totality)] = None

    structures: Annotated[
        URIRef | None, RdfProperty(CDI.PhysicalRecordSegmentStructure_structures_PhysicalRecordSegment)
    ] = None
    has_DataPointRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.PhysicalRecordSegmentStructure_has_DataPointRelationship)
    ] = None
...
class PhysicalSegmentLayout(CDIClass):
    ...
    arrayBase: Annotated[int | None, RdfProperty(CDI.PhysicalSegmentLayout_arrayBase)] = None
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.PhysicalSegmentLayout_catalogDetails)] = None
    commentPrefix: Annotated[str | None, RdfProperty(CDI.PhysicalSegmentLayout_commentPrefix)] = None
    delimiter: Annotated[str | None, RdfProperty(CDI.PhysicalSegmentLayout_delimiter)] = None
    encoding: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.PhysicalSegmentLayout_encoding)] = None
    escapeCharacter: Annotated[str | None, RdfProperty(CDI.PhysicalSegmentLayout_escapeCharacter)] = None
    hasHeader: Annotated[bool | None, RdfProperty(CDI.PhysicalSegmentLayout_hasHeader)] = None
    headerIsCaseSensitive: Annotated[bool | None, RdfProperty(CDI.PhysicalSegmentLayout_headerIsCaseSensitive)] = None
    headerRowCount: Annotated[int | None, RdfProperty(CDI.PhysicalSegmentLayout_headerRowCount)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PhysicalSegmentLayout_identifier)] = None
    ...
    lineTerminator: Annotated[list[str] | None, RdfProperty(CDI.PhysicalSegmentLayout_lineTerminator)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.PhysicalSegmentLayout_name)] = None
    nullSequence: Annotated[str | None, RdfProperty(CDI.PhysicalSegmentLayout_nullSequence)] = None
    overview: Annotated[InternationalString | None, RdfProperty(CDI.PhysicalSegmentLayout_overview)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.PhysicalSegmentLayout_purpose)] = None
    quoteCharacter: Annotated[str | None, RdfProperty(CDI.PhysicalSegmentLayout_quoteCharacter)] = None
    skipBlankRows: Annotated[bool | None, RdfProperty(CDI.PhysicalSegmentLayout_skipBlankRows)] = None
    skipDataColumns: Annotated[int | None, RdfProperty(CDI.PhysicalSegmentLayout_skipDataColumns)] = None
    skipInitialSpace: Annotated[bool | None, RdfProperty(CDI.PhysicalSegmentLayout_skipInitialSpace)] = None
    skipRows: Annotated[int | None, RdfProperty(CDI.PhysicalSegmentLayout_skipRows)] = None
    tableDirection: Annotated[TableDirectionValues | None, RdfProperty(CDI.PhysicalSegmentLayout_tableDirection)] = None
    textDirection: Annotated[TextDirectionValues | None, RdfProperty(CDI.PhysicalSegmentLayout_textDirection)] = None
    treatConsecutiveDelimitersAsOne: Annotated[
        bool | None, RdfProperty(CDI.PhysicalSegmentLayout_treatConsecutiveDelimitersAsOne)
    ] = None
    trim: Annotated[TrimValues | None, RdfProperty(CDI.PhysicalSegmentLayout_trim)] = None

    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalSegmentLayout_isDefinedBy_Concept)] = (
        None
    )
    formats: Annotated[URIRef | None, RdfProperty(CDI.PhysicalSegmentLayout_formats_LogicalRecord)] = None
    has_ValueMapping: Annotated[list[URIRef] | None, RdfProperty(CDI.PhysicalSegmentLayout_has_ValueMapping)] = None
    has_ValueMappingPosition: Annotated[
        list[URIRef] | None, RdfProperty(CDI.PhysicalSegmentLayout_has_ValueMappingPosition)
    ] = None
...
class PhysicalSegmentLocation(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.PhysicalSegmentLocation_catalogDetails)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.PhysicalSegmentLocation_identifier)] = None
...
class RecordRelation(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.RecordRelation_catalogDetails)] = None
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.RecordRelation_displayLabel)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.RecordRelation_identifier)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.RecordRelation_purpose)] = None
    usage: Annotated[InternationalString | None, RdfProperty(CDI.RecordRelation_usage)] = None

    maps: Annotated[list[URIRef], RdfProperty(CDI.RecordRelation_maps_LogicalRecord)]
    has_InstanceVariableMap: Annotated[list[URIRef] | None, RdfProperty(CDI.RecordRelation_has_InstanceVariableMap)] = (
        None
    )
...
class ValueMapping(CDIClass):
    ...
    decimalPositions: Annotated[int | None, RdfProperty(CDI.ValueMapping_decimalPositions)] = None
    defaultDecimalSeparator: Annotated[str | None, RdfProperty(CDI.ValueMapping_defaultDecimalSeparator)] = None
    defaultDigitGroupSeparator: Annotated[str | None, RdfProperty(CDI.ValueMapping_defaultDigitGroupSeparator)] = None
    defaultValue: Annotated[str, RdfProperty(CDI.ValueMapping_defaultValue)]
    format: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ValueMapping_format)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ValueMapping_identifier)] = None
    isRequired: Annotated[bool | None, RdfProperty(CDI.ValueMapping_isRequired)] = None
    length: Annotated[int | None, RdfProperty(CDI.ValueMapping_length)] = None
    maximumLength: Annotated[int | None, RdfProperty(CDI.ValueMapping_maximumLength)] = None
    minimumLength: Annotated[int | None, RdfProperty(CDI.ValueMapping_minimumLength)] = None
    nullSequence: Annotated[str | None, RdfProperty(CDI.ValueMapping_nullSequence)] = None
    numberPattern: Annotated[str | None, RdfProperty(CDI.ValueMapping_numberPattern)] = None
    physicalDataType: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ValueMapping_physicalDataType)] = None
    scale: Annotated[int | None, RdfProperty(CDI.ValueMapping_scale)] = None

    formats: Annotated[list[URIRef] | None, RdfProperty(CDI.ValueMapping_formats_DataPoint)] = None
    uses_PhysicalSegmentLocation: Annotated[
        URIRef | None, RdfProperty(CDI.ValueMapping_uses_PhysicalSegmentLocation)
    ] = None
...
class ValueMappingPosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ValueMappingPosition_identifier)] = None
...
class ValueMappingRelationship(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ValueMappingRelationship_identifier)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ValueMappingRelationship_semantics)] = None

    hasTarget: Annotated[list[URIRef] | None, RdfProperty(CDI.ValueMappingRelationship_hasTarget_ValueMapping)] = None
    hasSource: Annotated[list[URIRef] | None, RdfProperty(CDI.ValueMappingRelationship_hasSource_ValueMapping)] = None
...
class Activity(CDIClass):
    ...
    definition: Annotated[InternationalString | None, RdfProperty(CDI.Activity_definition)] = None
    description: Annotated[str | None, RdfProperty(CDI.Activity_description)] = None
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.Activity_displayLabel)] = None
    entityProduced: Annotated[list[Reference] | None, RdfProperty(CDI.Activity_entityProduced)] = None
    entityUsed: Annotated[list[Reference] | None, RdfProperty(CDI.Activity_entityUsed)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Activity_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.Activity_name)] = None
    standardModelMapping: Annotated[list[Reference] | None, RdfProperty(CDI.Activity_standardModelMapping)] = None

    hasInternal: Annotated[list[URIRef] | None, RdfProperty(CDI.Activity_hasInternal_ControlLogic)] = None
    hasSubActivity: Annotated[list[URIRef] | None, RdfProperty(CDI.Activity_hasSubActivity_Activity)] = None
    has_Step: Annotated[list[URIRef] | None, RdfProperty(CDI.Activity_has_Step)] = None
...
class ControlLogic(CDIClass):
    ...
    description: Annotated[str | None, RdfProperty(CDI.ControlLogic_description)] = None
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.ControlLogic_displayLabel)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ControlLogic_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ControlLogic_name)] = None
    workflow: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ControlLogic_workflow)] = None

    informs: Annotated[list[URIRef] | None, RdfProperty(CDI.ControlLogic_informs_ProcessingAgent)] = None
    invokes: Annotated[list[URIRef], RdfProperty(CDI.ControlLogic_invokes_Activity)]
    hasSubControlLogic: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ControlLogic_hasSubControlLogic_ControlLogic)
    ] = None
    has_InformationFlowDefinition: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ControlLogic_has_InformationFlowDefinition)
    ] = None
...
class InformationFlowDefinition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.InformationFlowDefinition_identifier)] = None

    from_Parameter: Annotated[URIRef | None, RdfProperty(CDI.InformationFlowDefinition_from_Parameter)] = None
    to: Annotated[list[URIRef] | None, RdfProperty(CDI.InformationFlowDefinition_to_Parameter)] = None
...
class Parameter(CDIClass):
    ...
    entityBound: Annotated[list[Reference] | None, RdfProperty(CDI.Parameter_entityBound)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Parameter_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.Parameter_name)] = None
...
class ProductionEnvironment(CDIClass):
    ...
    description: Annotated[str | None, RdfProperty(CDI.ProductionEnvironment_description)] = None
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.ProductionEnvironment_displayLabel)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ProductionEnvironment_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ProductionEnvironment_name)] = None
...
class Rule(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Rule_identifier)] = None

    hasPrecondition: Annotated[list[URIRef] | None, RdfProperty(CDI.Rule_hasPrecondition_ConditionalControlLogic)] = (
        None
    )
...
class RuleSet(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.RuleSet_identifier)] = None

    has_Rule: Annotated[list[URIRef] | None, RdfProperty(CDI.RuleSet_has_Rule)] = None
...
class SequencePosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.SequencePosition_identifier)] = None
...
class AuthorizationSource(CDIClass):
    ...
    authorizationDate: Annotated[CombinedDate | None, RdfProperty(CDI.AuthorizationSource_authorizationDate)] = None
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.AuthorizationSource_catalogDetails)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.AuthorizationSource_identifier)] = None
    legalMandate: Annotated[InternationalString | None, RdfProperty(CDI.AuthorizationSource_legalMandate)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.AuthorizationSource_purpose)] = None
    statementOfAuthorization: Annotated[
        InternationalString | None, RdfProperty(CDI.AuthorizationSource_statementOfAuthorization)
    ] = None

    has_Agent: Annotated[list[URIRef] | None, RdfProperty(CDI.AuthorizationSource_has_Agent)] = None
...
class CategoryStatistic(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.CategoryStatistic_identifier)] = None
    statistic: Annotated[list[Statistic] | None, RdfProperty(CDI.CategoryStatistic_statistic)] = None
    typeOfCategoryStatistic: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.CategoryStatistic_typeOfCategoryStatistic)
    ] = None

    appliesTo: Annotated[list[URIRef], RdfProperty(CDI.CategoryStatistic_appliesTo_InstanceVariable)]
    for_Category: Annotated[URIRef | None, RdfProperty(CDI.CategoryStatistic_for_Category)] = None
...
class ClassificationFamily(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.ClassificationFamily_catalogDetails)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationFamily_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ClassificationFamily_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.ClassificationFamily_purpose)] = None

    uses_ClassificationIndex: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ClassificationFamily_uses_ClassificationIndex)
    ] = None
    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.ClassificationFamily_isDefinedBy_Concept)] = (
        None
    )
    groups: Annotated[list[URIRef] | None, RdfProperty(CDI.ClassificationFamily_groups_ClassificationSeries)] = None
...
class ClassificationIndex(CDIClass):
    ...
    availableLanguage: Annotated[
        list[str] | None, RdfProperty(CDI.ClassificationIndex_availableLanguage, datatype=XSD.language)
    ] = None
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.ClassificationIndex_catalogDetails)] = None
    codingInstruction: Annotated[list[CommandCode] | None, RdfProperty(CDI.ClassificationIndex_codingInstruction)] = (
        None
    )
    corrections: Annotated[list[InternationalString] | None, RdfProperty(CDI.ClassificationIndex_corrections)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationIndex_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ClassificationIndex_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.ClassificationIndex_purpose)] = None
    releaseDate: Annotated[CombinedDate | None, RdfProperty(CDI.ClassificationIndex_releaseDate)] = None

    isMaintainedBy: Annotated[URIRef | None, RdfProperty(CDI.ClassificationIndex_isMaintainedBy_Agent)] = None
    hasContact: Annotated[list[URIRef] | None, RdfProperty(CDI.ClassificationIndex_hasContact_Agent)] = None
    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.ClassificationIndex_isDefinedBy_Concept)] = None
    has_ClassificationIndexEntryPosition: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ClassificationIndex_has_ClassificationIndexEntryPosition)
    ] = None
    has_ClassificationIndexEntry: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ClassificationIndex_has_ClassificationIndexEntry)
    ] = None
...
class ClassificationIndexEntry(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.ClassificationIndexEntry_catalogDetails)] = None
    codingInstruction: Annotated[CommandCode | None, RdfProperty(CDI.ClassificationIndexEntry_codingInstruction)] = None
    entry: Annotated[InternationalString | None, RdfProperty(CDI.ClassificationIndexEntry_entry)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationIndexEntry_identifier)] = None
    validDates: Annotated[DateRange | None, RdfProperty(CDI.ClassificationIndexEntry_validDates)] = None
...
class ClassificationIndexEntryPosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationIndexEntryPosition_identifier)] = None
...
class ClassificationItem(CDIClass):
    ...
    changeFromPreviousVersion: Annotated[
        InternationalString | None, RdfProperty(CDI.ClassificationItem_changeFromPreviousVersion)
    ] = None
    changeLog: Annotated[InternationalString | None, RdfProperty(CDI.ClassificationItem_changeLog)] = None
    explanatoryNotes: Annotated[
        list[InternationalString] | None, RdfProperty(CDI.ClassificationItem_explanatoryNotes)
    ] = None
    futureNotes: Annotated[list[InternationalString] | None, RdfProperty(CDI.ClassificationItem_futureNotes)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationItem_identifier)] = None
    isGenerated: Annotated[bool | None, RdfProperty(CDI.ClassificationItem_isGenerated)] = None
    isValid: Annotated[bool | None, RdfProperty(CDI.ClassificationItem_isValid)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ClassificationItem_name)] = None
    validDates: Annotated[DateRange | None, RdfProperty(CDI.ClassificationItem_validDates)] = None

    excludes: Annotated[list[URIRef] | None, RdfProperty(CDI.ClassificationItem_excludes_ClassificationItem)] = None
    ...
    hasRulingBy: Annotated[list[URIRef] | None, RdfProperty(CDI.ClassificationItem_hasRulingBy_AuthorizationSource)] = (
        None
    )
...
class ClassificationItemPosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationItemPosition_identifier)] = None
    value: Annotated[int, RdfProperty(CDI.ClassificationItemPosition_value)]

    indexes: Annotated[URIRef | None, RdfProperty(CDI.ClassificationItemPosition_indexes_ClassificationItem)] = None
...
class ClassificationItemRelationship(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationItemRelationship_identifier)] = None
    semantics: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.ClassificationItemRelationship_semantics)
    ] = None

    hasSource: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ClassificationItemRelationship_hasSource_ClassificationItem)
    ] = None
    hasTarget: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ClassificationItemRelationship_hasTarget_ClassificationItem)
    ] = None
...
class ClassificationItemStructure(CDIClass):
    ...
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.ClassificationItemStructure_displayLabel)] = (
        None
    )
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationItemStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ClassificationItemStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.ClassificationItemStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ClassificationItemStructure_semantics)] = (
        None
    )
    specification: Annotated[
        StructureSpecification | None, RdfProperty(CDI.ClassificationItemStructure_specification)
    ] = None
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ClassificationItemStructure_topology)] = None
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.ClassificationItemStructure_totality)] = None

    structures: Annotated[
        URIRef | None, RdfProperty(CDI.ClassificationItemStructure_structures_StatisticalClassification)
    ] = None
    has_ClassificationItemRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ClassificationItemStructure_has_ClassificationItemRelationship)
    ] = None
...
class ClassificationPosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationPosition_identifier)] = None
    value: Annotated[int, RdfProperty(CDI.ClassificationPosition_value)]

    indexes: Annotated[URIRef | None, RdfProperty(CDI.ClassificationPosition_indexes_StatisticalClassification)] = None
...
class ClassificationSeries(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.ClassificationSeries_catalogDetails)] = None
    context: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ClassificationSeries_context)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationSeries_identifier)] = None
    keyword: Annotated[list[ControlledVocabularyEntry] | None, RdfProperty(CDI.ClassificationSeries_keyword)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ClassificationSeries_name)] = None
    objectsOrUnitsClassified: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.ClassificationSeries_objectsOrUnitsClassified)
    ] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.ClassificationSeries_purpose)] = None
    subject: Annotated[list[ControlledVocabularyEntry] | None, RdfProperty(CDI.ClassificationSeries_subject)] = None

    isOwnedBy: Annotated[list[URIRef] | None, RdfProperty(CDI.ClassificationSeries_isOwnedBy_Agent)] = None
    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.ClassificationSeries_isDefinedBy_Concept)] = (
        None
    )
    has_StatisticalClassification: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ClassificationSeries_has_StatisticalClassification)
    ] = None
    has_ClassificationPosition: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ClassificationSeries_has_ClassificationPosition)
    ] = None
...
class ClassificationSeriesStructure(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ClassificationSeriesStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.ClassificationSeriesStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.ClassificationSeriesStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ClassificationSeriesStructure_semantics)] = (
        None
    )
    specification: Annotated[
        StructureSpecification | None, RdfProperty(CDI.ClassificationSeriesStructure_specification)
    ] = None
    topology: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.ClassificationSeriesStructure_topology)] = (
        None
    )
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.ClassificationSeriesStructure_totality)] = None

    structures: Annotated[
        URIRef | None, RdfProperty(CDI.ClassificationSeriesStructure_structures_ClassificationSeries)
    ] = None
    has_StatisticalClassificationRelationship: Annotated[
        list[URIRef] | None, RdfProperty(CDI.ClassificationSeriesStructure_has_StatisticalClassificationRelationship)
    ] = None
...
class Code(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Code_identifier)] = None
...
class CodeListStructure(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.CodeListStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.CodeListStructure_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.CodeListStructure_purpose)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.CodeListStructure_semantics)] = None
    specification: Annotated[StructureSpecification | None, RdfProperty(CDI.CodeListStructure_specification)] = None
    topology: Annotated[ControlledVocabularyEntry, RdfProperty(CDI.CodeListStructure_topology)]
    totality: Annotated[StructureExtent | None, RdfProperty(CDI.CodeListStructure_totality)] = None

    structures: Annotated[URIRef | None, RdfProperty(CDI.CodeListStructure_structures_CodeList)] = None
    has_CodeRelationship: Annotated[list[URIRef] | None, RdfProperty(CDI.CodeListStructure_has_CodeRelationship)] = None
...
class CodePosition(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.CodePosition_identifier)] = None
    value: Annotated[int, RdfProperty(CDI.CodePosition_value)]

    indexes: Annotated[URIRef | None, RdfProperty(CDI.CodePosition_indexes_Code)] = None
...
class CodeRelationship(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.CodeRelationship_identifier)] = None
    semantics: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.CodeRelationship_semantics)] = None

    hasTarget: Annotated[list[URIRef] | None, RdfProperty(CDI.CodeRelationship_hasTarget_Code)] = None
    hasSource: Annotated[list[URIRef] | None, RdfProperty(CDI.CodeRelationship_hasSource_Code)] = None
...
class CorrespondenceTable(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.CorrespondenceTable_catalogDetails)] = None
    effectiveDates: Annotated[DateRange | None, RdfProperty(CDI.CorrespondenceTable_effectiveDates)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.CorrespondenceTable_identifier)] = None

    hasSource: Annotated[URIRef | None, RdfProperty(CDI.CorrespondenceTable_hasSource_Level)] = None
    hasTarget: Annotated[URIRef | None, RdfProperty(CDI.CorrespondenceTable_hasTarget_Level)] = None
    isOwnedBy: Annotated[list[URIRef] | None, RdfProperty(CDI.CorrespondenceTable_isOwnedBy_Agent)] = None
    mapsTo: Annotated[list[URIRef], RdfProperty(CDI.CorrespondenceTable_mapsTo_StatisticalClassification)]
    hasContact: Annotated[list[URIRef] | None, RdfProperty(CDI.CorrespondenceTable_hasContact_Agent)] = None
    isMaintainedBy: Annotated[URIRef | None, RdfProperty(CDI.CorrespondenceTable_isMaintainedBy_Agent)] = None
    has_ConceptMap: Annotated[list[URIRef] | None, RdfProperty(CDI.CorrespondenceTable_has_ConceptMap)] = None
...
class EnumerationDomain(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.EnumerationDomain_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.EnumerationDomain_name)] = None
    purpose: Annotated[InternationalString | None, RdfProperty(CDI.EnumerationDomain_purpose)] = None

    uses_LevelStructure: Annotated[URIRef | None, RdfProperty(CDI.EnumerationDomain_uses_LevelStructure)] = None
    references: Annotated[URIRef | None, RdfProperty(CDI.EnumerationDomain_references_CategorySet)] = None
    isDefinedBy_Concept: Annotated[list[URIRef] | None, RdfProperty(CDI.EnumerationDomain_isDefinedBy_Concept)] = None
...
class Level(CDIClass):
    ...
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.Level_displayLabel)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.Level_identifier)] = None
    levelNumber: Annotated[int, RdfProperty(CDI.Level_levelNumber)]

    isDefinedBy_Concept: Annotated[URIRef | None, RdfProperty(CDI.Level_isDefinedBy_Concept)] = None
    groups: Annotated[list[URIRef] | None, RdfProperty(CDI.Level_groups_ClassificationItem)] = None
...
class LevelStructure(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.LevelStructure_catalogDetails)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.LevelStructure_identifier)] = None
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.LevelStructure_name)] = None
    usage: Annotated[InternationalString | None, RdfProperty(CDI.LevelStructure_usage)] = None
    validDateRange: Annotated[DateRange | None, RdfProperty(CDI.LevelStructure_validDateRange)] = None

    has_Level: Annotated[list[URIRef] | None, RdfProperty(CDI.LevelStructure_has_Level)] = None
...
class StatisticalClassificationRelationship(CDIClass):
    ...
    identifier: Annotated[Identifier | None, RdfProperty(CDI.StatisticalClassificationRelationship_identifier)] = None
    semantics: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.StatisticalClassificationRelationship_semantics)
    ] = None

    hasTarget: Annotated[
        list[URIRef] | None, RdfProperty(CDI.StatisticalClassificationRelationship_hasTarget_StatisticalClassification)
    ] = None
    hasSource: Annotated[
        list[URIRef] | None, RdfProperty(CDI.StatisticalClassificationRelationship_hasSource_StatisticalClassification)
    ] = None
...
class ValueAndConceptDescription(CDIClass):
    ...
    classificationLevel: Annotated[
        CategoryRelationCode | None, RdfProperty(CDI.ValueAndConceptDescription_classificationLevel)
    ] = None
    description: Annotated[InternationalString | None, RdfProperty(CDI.ValueAndConceptDescription_description)] = None
    formatPattern: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.ValueAndConceptDescription_formatPattern)
    ] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ValueAndConceptDescription_identifier)] = None
    logicalExpression: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.ValueAndConceptDescription_logicalExpression)
    ] = None
    maximumValueExclusive: Annotated[str | None, RdfProperty(CDI.ValueAndConceptDescription_maximumValueExclusive)] = (
        None
    )
    maximumValueInclusive: Annotated[str | None, RdfProperty(CDI.ValueAndConceptDescription_maximumValueInclusive)] = (
        None
    )
    minimumValueExclusive: Annotated[str | None, RdfProperty(CDI.ValueAndConceptDescription_minimumValueExclusive)] = (
        None
    )
    minimumValueInclusive: Annotated[str | None, RdfProperty(CDI.ValueAndConceptDescription_minimumValueInclusive)] = (
        None
    )
    regularExpression: Annotated[TypedString | None, RdfProperty(CDI.ValueAndConceptDescription_regularExpression)] = (
        None
    )
...
class ValueDomain(CDIClass):
    ...
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.ValueDomain_catalogDetails)] = None
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.ValueDomain_displayLabel)] = None
    identifier: Annotated[Identifier | None, RdfProperty(CDI.ValueDomain_identifier)] = None
    recommendedDataType: Annotated[
        list[ControlledVocabularyEntry] | None, RdfProperty(CDI.ValueDomain_recommendedDataType)
    ] = None
...
class ProcessingAgent(Agent):
    ...
    performs: Annotated[list[URIRef] | None, RdfProperty(CDI.ProcessingAgent_performs_Activity)] = None
    operatesOn: Annotated[list[URIRef] | None, RdfProperty(CDI.ProcessingAgent_operatesOn_ProductionEnvironment)] = None
...
class Individual(Agent):
    ...
    contactInformation: Annotated[ContactInformation | None, RdfProperty(CDI.Individual_contactInformation)] = None
    individualName: Annotated[list[IndividualName] | None, RdfProperty(CDI.Individual_individualName)] = None
...
class Organization(Agent):
    ...
    contactInformation: Annotated[ContactInformation | None, RdfProperty(CDI.Organization_contactInformation)] = None
...
class Machine(Agent):
    ...
    accessLocation: Annotated[AccessLocation | None, RdfProperty(CDI.Machine_accessLocation)] = None
    function: Annotated[list[ControlledVocabularyEntry] | None, RdfProperty(CDI.Machine_function)] = None
    machineInterface: Annotated[list[ControlledVocabularyEntry] | None, RdfProperty(CDI.Machine_machineInterface)] = (
        None
    )
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.Machine_name)] = None
    ownerOperatorContact: Annotated[ContactInformation | None, RdfProperty(CDI.Machine_ownerOperatorContact)] = None
    typeOfMachine: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Machine_typeOfMachine)] = None
...
class UnitType(Concept):
    ...
    descriptiveText: Annotated[InternationalString | None, RdfProperty(CDI.UnitType_descriptiveText)] = None
...
class Category(Concept):
    ...
    descriptiveText: Annotated[InternationalString | None, RdfProperty(CDI.Category_descriptiveText)] = None
...
class ConceptualVariable(Concept):
    ...
    descriptiveText: Annotated[InternationalString | None, RdfProperty(CDI.ConceptualVariable_descriptiveText)] = None
    unitOfMeasureKind: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.ConceptualVariable_unitOfMeasureKind)
    ] = None

    takesSentinelConceptsFrom: Annotated[
        URIRef | None, RdfProperty(CDI.ConceptualVariable_takesSentinelConceptsFrom_SentinelConceptualDomain)
    ] = None
    takesSubstantiveConceptsFrom: Annotated[
        URIRef | None, RdfProperty(CDI.ConceptualVariable_takesSubstantiveConceptsFrom_SubstantiveConceptualDomain)
    ] = None
    measures: Annotated[URIRef | None, RdfProperty(CDI.ConceptualVariable_measures_UnitType)] = None
...
class CategorySet(ConceptSystem):
    ...
    has_Category: Annotated[list[URIRef] | None, RdfProperty(CDI.CategorySet_has_Category)] = None
    has_CategoryPosition: Annotated[list[URIRef] | None, RdfProperty(CDI.CategorySet_has_CategoryPosition)] = None
...
class DimensionalDataSet(DataSet):
    ...
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.DimensionalDataSet_name)] = None

    represents: Annotated[list[URIRef] | None, RdfProperty(CDI.DimensionalDataSet_represents_ScopedMeasure)] = None
...
class RevisableDatum(Datum):
    ...
    correspondsTo_Revision: Annotated[URIRef | None, RdfProperty(CDI.RevisableDatum_correspondsTo_Revision)] = None
...
class ReferenceValue(InstanceValue):
    ...
    correspondsTo_VariableValueComponent: Annotated[
        URIRef, RdfProperty(CDI.ReferenceValue_correspondsTo_VariableValueComponent)
    ]
    hasValueFrom_ReferenceValueDomain: Annotated[
        URIRef, RdfProperty(CDI.ReferenceValue_hasValueFrom_ReferenceValueDomain)
    ]
...
class KeyMember(InstanceValue):
    ...
    isBasedOn: Annotated[list[URIRef] | None, RdfProperty(CDI.KeyMember_isBasedOn_DataStructureComponent)] = None
...
class InstanceKey(Key):
    ...
    has_InstanceValue: Annotated[URIRef | None, RdfProperty(CDI.InstanceKey_has_InstanceValue)] = None
...
class DimensionComponent(DataStructureComponent):
    ...
    categoricalAdditivity: Annotated[bool | None, RdfProperty(CDI.DimensionComponent_categoricalAdditivity)] = None

    isStructuredBy: Annotated[URIRef | None, RdfProperty(CDI.DimensionComponent_isStructuredBy_ValueDomain)] = None
...
class MeasureComponent(DataStructureComponent):
    ...
    name: Annotated[list[ObjectName] | None, RdfProperty(CDI.MeasureComponent_name)] = None
...
class AttributeComponent(DataStructureComponent):
    ...
    qualifies: Annotated[list[URIRef] | None, RdfProperty(CDI.AttributeComponent_qualifies_DataStructureComponent)] = (
        None
    )
...
class DataStructure(DataStructureComponent):
    ...
    has_ForeignKey: Annotated[list[URIRef] | None, RdfProperty(CDI.DataStructure_has_ForeignKey)] = None
    has_DataStructureComponent: Annotated[
        list[URIRef] | None, RdfProperty(CDI.DataStructure_has_DataStructureComponent)
    ] = None
    has_ComponentPosition: Annotated[list[URIRef] | None, RdfProperty(CDI.DataStructure_has_ComponentPosition)] = None
    has_PrimaryKey: Annotated[URIRef | None, RdfProperty(CDI.DataStructure_has_PrimaryKey)] = None
...
class VariableDescriptorComponent(DataStructureComponent):
    ...
    isDefinedBy_DescriptorVariable: Annotated[
        URIRef | None, RdfProperty(CDI.VariableDescriptorComponent_isDefinedBy_DescriptorVariable)
    ] = None
...
class SegmentByText(PhysicalSegmentLocation):
    ...
    characterLength: Annotated[int | None, RdfProperty(CDI.SegmentByText_characterLength)] = None
    endCharacterPosition: Annotated[int | None, RdfProperty(CDI.SegmentByText_endCharacterPosition)] = None
    endLine: Annotated[int | None, RdfProperty(CDI.SegmentByText_endLine)] = None
    startCharacterPosition: Annotated[int | None, RdfProperty(CDI.SegmentByText_startCharacterPosition)] = None
    startLine: Annotated[int | None, RdfProperty(CDI.SegmentByText_startLine)] = None
...
class Step(Activity):
    ...
    script: Annotated[CommandCode | None, RdfProperty(CDI.Step_script)] = None
    scriptingLanguage: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.Step_scriptingLanguage)] = None

    produces: Annotated[list[URIRef] | None, RdfProperty(CDI.Step_produces_Parameter)] = None
    receives: Annotated[list[URIRef] | None, RdfProperty(CDI.Step_receives_Parameter)] = None
    hasSubStep: Annotated[list[URIRef] | None, RdfProperty(CDI.Step_hasSubStep_Step)] = None
...
class CodeList(EnumerationDomain):
    ...
    has_CodePosition: Annotated[list[URIRef] | None, RdfProperty(CDI.CodeList_has_CodePosition)] = None
    has_Code: Annotated[list[URIRef] | None, RdfProperty(CDI.CodeList_has_Code)] = None
...
class StatisticalClassification(EnumerationDomain):
    ...
    availableLanguage: Annotated[
        list[str] | None, RdfProperty(CDI.StatisticalClassification_availableLanguage, datatype=XSD.language)
    ] = None
    catalogDetails: Annotated[CatalogDetails | None, RdfProperty(CDI.StatisticalClassification_catalogDetails)] = None
    changeFromBase: Annotated[InternationalString | None, RdfProperty(CDI.StatisticalClassification_changeFromBase)] = (
        None
    )
    copyright: Annotated[list[InternationalString] | None, RdfProperty(CDI.StatisticalClassification_copyright)] = None
    displayLabel: Annotated[list[LabelForDisplay] | None, RdfProperty(CDI.StatisticalClassification_displayLabel)] = (
        None
    )
    isCurrent: Annotated[bool | None, RdfProperty(CDI.StatisticalClassification_isCurrent)] = None
    isFloating: Annotated[bool | None, RdfProperty(CDI.StatisticalClassification_isFloating)] = None
    purposeOfVariant: Annotated[
        InternationalString | None, RdfProperty(CDI.StatisticalClassification_purposeOfVariant)
    ] = None
    rationale: Annotated[InternationalString | None, RdfProperty(CDI.StatisticalClassification_rationale)] = None
    releaseDate: Annotated[CombinedDate | None, RdfProperty(CDI.StatisticalClassification_releaseDate)] = None
    updateChanges: Annotated[
        list[InternationalString] | None, RdfProperty(CDI.StatisticalClassification_updateChanges)
    ] = None
    usage: Annotated[InternationalString | None, RdfProperty(CDI.StatisticalClassification_usage)] = None
    validDates: Annotated[DateRange | None, RdfProperty(CDI.StatisticalClassification_validDates)] = None

    isMaintainedBy: Annotated[
        list[URIRef] | None, RdfProperty(CDI.StatisticalClassification_isMaintainedBy_Organization)
    ] = None
    isIndexedBy: Annotated[
        list[URIRef] | None, RdfProperty(CDI.StatisticalClassification_isIndexedBy_ClassificationIndex)
    ] = None
    isVariantOf: Annotated[
        URIRef | None, RdfProperty(CDI.StatisticalClassification_isVariantOf_StatisticalClassification)
    ] = None
    isSuccessorOf: Annotated[
        list[URIRef] | None, RdfProperty(CDI.StatisticalClassification_isSuccessorOf_StatisticalClassification)
    ] = None
    isPredecessorOf: Annotated[
        list[URIRef] | None, RdfProperty(CDI.StatisticalClassification_isPredecessorOf_StatisticalClassification)
    ] = None
    has_ClassificationItemPosition: Annotated[
        list[URIRef] | None, RdfProperty(CDI.StatisticalClassification_has_ClassificationItemPosition)
    ] = None
    has_ClassificationItem: Annotated[
        list[URIRef] | None, RdfProperty(CDI.StatisticalClassification_has_ClassificationItem)
    ] = None
    has_LevelStructure: Annotated[URIRef | None, RdfProperty(CDI.StatisticalClassification_has_LevelStructure)] = None
...
class SubstantiveValueDomain(ValueDomain):
    ...
    takesValuesFrom: Annotated[
        URIRef | None, RdfProperty(CDI.SubstantiveValueDomain_takesValuesFrom_EnumerationDomain)
    ] = None
    isDescribedBy: Annotated[
        URIRef | None, RdfProperty(CDI.SubstantiveValueDomain_isDescribedBy_ValueAndConceptDescription)
    ] = None
    takesConceptsFrom: Annotated[
        URIRef | None, RdfProperty(CDI.SubstantiveValueDomain_takesConceptsFrom_SubstantiveConceptualDomain)
    ] = None
...
class SentinelValueDomain(ValueDomain):
    ...
    platformType: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.SentinelValueDomain_platformType)] = None

    takesConceptsFrom: Annotated[
        URIRef | None, RdfProperty(CDI.SentinelValueDomain_takesConceptsFrom_SentinelConceptualDomain)
    ] = None
    takesValuesFrom: Annotated[
        URIRef | None, RdfProperty(CDI.SentinelValueDomain_takesValuesFrom_EnumerationDomain)
    ] = None
    isDescribedBy: Annotated[
        URIRef | None, RdfProperty(CDI.SentinelValueDomain_isDescribedBy_ValueAndConceptDescription)
    ] = None
...
class Universe(UnitType):
    ...
    isInclusive: Annotated[bool | None, RdfProperty(CDI.Universe_isInclusive)] = None
...
class DimensionalKeyDefinitionMember(ConceptualValue):
    ...
    isRepresentedBy: Annotated[
        list[URIRef], RdfProperty(CDI.DimensionalKeyDefinitionMember_isRepresentedBy_DimensionalKeyMember)
    ]
...
class RepresentedVariable(ConceptualVariable):
    ...
    describedUnitOfMeasure: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.RepresentedVariable_describedUnitOfMeasure)
    ] = None
    hasIntendedDataType: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.RepresentedVariable_hasIntendedDataType)
    ] = None
    simpleUnitOfMeasure: Annotated[str | None, RdfProperty(CDI.RepresentedVariable_simpleUnitOfMeasure)] = None

    takesSentinelValuesFrom: Annotated[
        list[URIRef] | None, RdfProperty(CDI.RepresentedVariable_takesSentinelValuesFrom_SentinelValueDomain)
    ] = None
    takesSubstantiveValuesFrom_SubstantiveValueDomain: Annotated[
        URIRef | None, RdfProperty(CDI.RepresentedVariable_takesSubstantiveValuesFrom_SubstantiveValueDomain)
    ] = None
...
class Descriptor(KeyMember):
    ...
    hasValueFrom_DescriptorValueDomain: Annotated[
        URIRef, RdfProperty(CDI.Descriptor_hasValueFrom_DescriptorValueDomain)
    ]
...
class MainKeyMember(KeyMember):
    ...
    hasValueFrom_SubstantiveValueDomain: Annotated[
        URIRef | None, RdfProperty(CDI.MainKeyMember_hasValueFrom_SubstantiveValueDomain)
    ] = None
...
class QualifiedMeasure(MeasureComponent):
    ...
    refines: Annotated[URIRef | None, RdfProperty(CDI.QualifiedMeasure_refines_MeasureComponent)] = None
...
class DimensionalDataStructure(DataStructure):
    ...
    uses_DimensionGroup: Annotated[
        list[URIRef] | None, RdfProperty(CDI.DimensionalDataStructure_uses_DimensionGroup)
    ] = None
...
class Sequence(DeterministicImperative):
    ...
    has_SequencePosition: Annotated[list[URIRef] | None, RdfProperty(CDI.Sequence_has_SequencePosition)] = None
...
class RuleBasedScheduling(NonDeterministicDeclarative):
    ...
    has_RuleSet: Annotated[list[URIRef] | None, RdfProperty(CDI.RuleBasedScheduling_has_RuleSet)] = None
    has_Curator: Annotated[list[URIRef] | None, RdfProperty(CDI.RuleBasedScheduling_has_Curator)] = None
...
class Population(Universe):
    ...
    timePeriodOfPopulation: Annotated[list[DateRange] | None, RdfProperty(CDI.Population_timePeriodOfPopulation)] = None

    isComposedOf: Annotated[list[URIRef] | None, RdfProperty(CDI.Population_isComposedOf_Unit)] = None
...
class InstanceVariable(RepresentedVariable):
    ...
    physicalDataType: Annotated[
        ControlledVocabularyEntry | None, RdfProperty(CDI.InstanceVariable_physicalDataType)
    ] = None
    platformType: Annotated[ControlledVocabularyEntry | None, RdfProperty(CDI.InstanceVariable_platformType)] = None
    source: Annotated[Reference | None, RdfProperty(CDI.InstanceVariable_source)] = None
    variableFunction: Annotated[
        list[ControlledVocabularyEntry] | None, RdfProperty(CDI.InstanceVariable_variableFunction)
    ] = None

    has_PhysicalSegmentLayout: Annotated[
        list[URIRef] | None, RdfProperty(CDI.InstanceVariable_has_PhysicalSegmentLayout)
    ] = None
    has_ValueMapping: Annotated[URIRef | None, RdfProperty(CDI.InstanceVariable_has_ValueMapping)] = None
...
class AllenIntervalAlgebra(TemporalConstraints):
    ...
    temporalIntervalRelation: Annotated[
        TemporalRelation, RdfProperty(CDI.AllenIntervalAlgebra_temporalIntervalRelation)
    ]
...
class DescriptorVariable(InstanceVariable):
    ...
    takesSubstantiveValuesFrom_DescriptorValueDomain: Annotated[
        URIRef | None, RdfProperty(CDI.DescriptorVariable_takesSubstantiveValuesFrom_DescriptorValueDomain)
    ] = None
...
class ReferenceVariable(InstanceVariable):
    ...
    takesValuesFrom: Annotated[
        URIRef | None, RdfProperty(CDI.ReferenceVariable_takesValuesFrom_ReferenceValueDomain)
    ] = None
